...
if(isset($_SESSION["id"]) && $_SESSION["privilege"] == "2") {
	...
	if(!empty($period) and !empty($level)) {
		...
		if($num_check_exist != 0) {
			...
			for($i = 0; $i<$data_size; $i++) {
				...
				if($query_spp) {
					...
					$redirect_url	= "mainpage.php?pl=spp_smp_setting";
					$redirect_text	= "Perubahan nilai SPP SMP sudah disimpan";
			...
			$redirect_url	= "mainpage.php?pl=spp_smp_setting";
			$redirect_text	= "Pengaturan nilai SPP untuk tahun $period dan level $level, belum dilalukan. Anda akan diarahkan kehalaman pembuatan nilai SPP untuk SMP";
		...
		$redirect_path	= "";
		$redirect_icon	= "images/icon_false.png";
		$redirect_url	= "mainpage.php?pl=spp_smp_edit";
