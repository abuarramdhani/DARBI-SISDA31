                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">            	
                            <tr height="20">
                                ...
                                <script type="text/javascript" src="global_js/auto_suggest_form.js"></script>                                
                                    <div id="suggest">
                                      <input type="text" size="25" name="no_sisda" value="" id="sisda_id" onkeyup="suggest(this.value);" onblur="fill();" class="" />
                                ...
                                <td width="10">&nbsp;</td>
                                <td><!-- the verification function returned here, in submit button, check the whole script below --><input type="submit" value="Lakukan transaksi" onClick="return verification1()"/><input type="reset" value="Kosongkan" /></td>
                            </tr>
                        </table>
                        </form>
                    </td>
                    ...
                    <td colspan="3">
                    	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#f1f1f1">            	
                            <tr height="20">
                                ...
                                <td width="5"></td>
                                <td width="10" align="left"><input size="35" type="text" name="no_sisda" readonly="readonly" value="<?PHP echo $no_sisda_enc; ?>" /></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td align="left"><input size="35" type="text" name="nama_siswa" readonly="readonly" value="<?PHP echo $row_select_siswa["nama_siswa"]; ?>" /></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td colspan="3" height="5"></td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td align="left"><input size="35" type="text" name="jenjang" readonly="readonly" value="<?PHP echo $row_select_siswa["jenjang"]; ?>" /></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td colspan="3" height="5"></td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td align="left"><input size="35" type="text" readonly="readonly" value="<?PHP echo $row_select_siswa["tingkat"]; ?>" /></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td colspan="3" height="5"></td>
