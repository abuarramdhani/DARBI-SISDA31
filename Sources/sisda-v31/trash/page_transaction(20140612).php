                                            ...
                                            <td colspan="4">
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
														...
														?>
                                                        <option value="<?PHP echo $row_avai_year_spp["periode"]; ?>"><?PHP echo $row_avai_year_spp["periode"]; ?></option>
                                                        <?PHP
														}
														?>
                                                        </select>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="5" bgcolor="#617f90"></td>
                                                        <td width="10" bgcolor="#617f90" align="left"><input type="text" name="nom_spp" onkeypress="return checkIt(event)"  onKeyUp="MakeSum();" style="font-weight:bold; color:#33CC00; font-size:14px;"/></td>
                                                        <td width="10" bgcolor="#617f90">&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                    <tr>
