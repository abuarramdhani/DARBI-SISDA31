...
if(isset($_SESSION["id"]) && $_SESSION["privilege"] == "2") {
	...
	if(!empty($period) and !empty($level)) {
		...
		if($num_check_exist != 0) {
			...
			$redirect_text	= "Mohon maaf, pengaturan SPP dan item lainnya untuk level $level, <br>tahun ajaran $period sudah dilakukan. <br>Silahkan lakukan proses edit untuk melakukan perubahan nilai.";
