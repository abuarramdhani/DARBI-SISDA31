...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
    	...
    	<td align="center">
			...
			?>
			<form method="post" name="reg_adm_siswa" action="engine.php?case=reg_adm_siswa_update">             
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">            	             
                <tr>
                ...
                <tr height="30">                	
                    ...
                    <td width="200" bgcolor="#999999" id="text_normal_white" align="left">Nama murid</td>
                    <td width="10"></td>
