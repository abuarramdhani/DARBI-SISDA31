...
if(mysql_num_rows($query_get_tunggakan) != 0) {
	...
	while($row_tunggakan = mysql_fetch_array($query_get_tunggakan)) {
		...
		if($cur_jenis_tunggakan == "spp") {
			...
			$src_new_value_spp		= "update tunggakan set $last_month_checked = '$last_value', $cur_month = '$cur_value' where jenis_tunggakan = '$cur_jenis_tunggakan' and periode = '$year_checked'";
			...
			$src_new_value_cataj	= "update tunggakan set $last_month_cataj_checked = '$last_value', $cur_month_cataj = '$cur_value' where jenis_tunggakan = '$cur_jenis_tunggakan' and periode = '$year_checked'";
