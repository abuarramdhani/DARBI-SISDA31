					...
					*/
                    ...
                    while($row_get_cat_adm_bi_ma	= mysql_fetch_array($query_get_cat_adm_bi_ma)) {
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "umum") {
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>
                            <tr height="45" bgcolor="#7b8a74" id="text_normal_white">
                                <td>Umum</td>
                        		<td><input type="text" name="tkx_penga_umum" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>
                        		<td><input type="text" name="tkx_kegia_umum" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>
                        		<td><input type="text" name="tkx_peral_umum" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>
                        		<td><input type="text" name="tkx_serag_umum" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>
                        		<td><input type="text" name="tkx_paket_umum" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "berdesaukan") {
                            ...
                            <tr height="45" bgcolor="#7b8a74" id="text_normal_white">
                        		...
                        		<td><input type="text" name="tkx_penga_berdesaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>
                        		<td><input type="text" name="tkx_kegia_berdesaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>
                        		<td><input type="text" name="tkx_peral_berdesaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>
                        		<td><input type="text" name="tkx_serag_berdesaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>
                        		<td><input type="text" name="tkx_paket_berdesaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "memsaukan") {
                            ...
                            <tr height="45" bgcolor="#7b8a74" id="text_normal_white">
                        		...
                        		<td><input type="text" name="tkx_penga_memsaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>
                        		<td><input type="text" name="tkx_kegia_memsaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>
                        		<td><input type="text" name="tkx_peral_memsaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>
                        		<td><input type="text" name="tkx_serag_memsaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>
                        		<td><input type="text" name="tkx_paket_memsaukan" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "umgrab") {
                            ...
                            <tr height="45" bgcolor="#7b8a74" id="text_normal_white">
                            	<td>Umum Grade B</td>
                        		<td><input type="text" name="tkx_penga_umgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>
                        		<td><input type="text" name="tkx_kegia_umgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>
                        		<td><input type="text" name="tkx_peral_umgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>
                        		<td><input type="text" name="tkx_serag_umgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>
                        		<td><input type="text" name="tkx_paket_umgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "umsksmpgrab") {
                        	...
                        	<tr height="45" bgcolor="#7b8a74" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_umsksmpgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>
                        		<td><input type="text" name="tkx_kegia_umsksmpgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>
                        		<td><input type="text" name="tkx_peral_umsksmpgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>
                        		<td><input type="text" name="tkx_serag_umsksmpgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>
                        		<td><input type="text" name="tkx_paket_umsksmpgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "asdar") {
                            ...
                            <td>Asal Darbi</td>
                        		<td><input type="text" name="tkx_penga_asdar" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>
                        		<td><input type="text" name="tkx_kegia_asdar" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>
                        		<td><input type="text" name="tkx_peral_asdar" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>
                        		<td><input type="text" name="tkx_serag_asdar" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>
                        		<td><input type="text" name="tkx_paket_asdar" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "asdargraa") {
                        	...
                        	<tr height="45" bgcolor="#718b88" id="text_normal_white">                    	
                                ...
                                <td><input type="text" name="tkx_penga_asdargraa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>
                        		<td><input type="text" name="tkx_kegia_asdargraa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>
                        		<td><input type="text" name="tkx_peral_asdargraa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>
                        		<td><input type="text" name="tkx_serag_asdargraa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>
                        		<td><input type="text" name="tkx_paket_asdargraa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "asdargrab") {
                        	...
                        	<tr height="45" bgcolor="#718b88" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_asdargrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>
                        		<td><input type="text" name="tkx_kegia_asdargrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>
                        		<td><input type="text" name="tkx_peral_asdargrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>
                        		<td><input type="text" name="tkx_serag_asdargrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>
                        		<td><input type="text" name="tkx_paket_asdargrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>    
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg1") {
                        	...
                        	<tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg1" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?> 
                        		<td><input type="text" name="tkx_kegia_anpeg1" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg1" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                        		<td><input type="text" name="tkx_serag_anpeg1" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>		
                                <td><input type="text" name="tkx_paket_anpeg1" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg2") {
                        	...
                        	<tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                            <?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>    
                        		<td><input type="text" name="tkx_kegia_anpeg2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_anpeg2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_anpeg2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg3") {
                            ...
                            <tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg3" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_anpeg3" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg3" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_anpeg3" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_anpeg3" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg1graa") {
                            ...
                            <tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg1graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_anpeg1graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg1graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_anpeg1graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_anpeg1graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg1grab") {
                            ...
                            <tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg1grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_anpeg1grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg1grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_anpeg1grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_anpeg1grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg2graa") {
                            ...
                            <tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg2graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_anpeg2graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg2graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_anpeg2graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_anpeg2graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg2grab") {
                        	...
                        	<tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg2grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_anpeg2grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg2grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_anpeg2grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_anpeg2grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg3graa") {
                            ...
                            <tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg3graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_anpeg3graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg3graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_anpeg3graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_anpeg3graa" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "anpeg3grab") {
                            ...
                            <tr height="45" bgcolor="#617f90" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_anpeg3grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_anpeg3grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_anpeg3grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_anpeg3grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_anpeg3grab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "pintodsem2") {
                            ...
                            <tr height="45" bgcolor="#87778a" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_pintodsem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_pintodsem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_pintodsem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_pintodsem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_pintodsem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "pinpgtksem2") {
                            ...
                            <tr height="45" bgcolor="#87778a" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "pinsd34") {
                            ...
                            <tr height="45" bgcolor="#87778a" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_pinsd34" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_pinsd34" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_pinsd34" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_pinsd34" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_pinsd34" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "pinsd56") {
                            ...
                            <tr height="45" bgcolor="#87778a" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_pinsd56" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_pinsd56" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_pinsd56" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_pinsd56" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_pinsd56" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "pinsmp8") {
                            ...
                            <tr height="45" bgcolor="#87778a" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_pinsmp8" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_pinsmp8" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_pinsmp8" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_pinsmp8" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_pinsmp8" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
						...
						if($row_get_cat_adm_bi_ma["set_cat_adm"] == "pinsmp9") {
                            ...
                            <tr height="45" bgcolor="#87778a" id="text_normal_white">
                                ...
                                <td><input type="text" name="tkx_penga_pinsmp9" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
							?>	
                                <td><input type="text" name="tkx_kegia_pinsmp9" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
							?>	
                                <td><input type="text" name="tkx_peral_pinsmp9" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
							?>	
                                <td><input type="text" name="tkx_serag_pinsmp9" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "tkx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
							?>	
                                <td><input type="text" name="tkx_paket_pinsmp9" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
                        	<?PHP
							}
							if($row_get_cat_adm_bi_ma["level"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
							?>	
