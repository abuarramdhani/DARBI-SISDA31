    	...
    	<td>
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="20">
                    ...
                    <td width="5"></td>
                    <td>
						<select name="kelas" size="4" style="width: 150px"></select> <span id="text_normal_black">Kelas saat ini adalah <b><?PHP echo $row_get_data_siswa_finance["kelas"]; ?></b></span>
                    </td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                ...
                <tr height="20">
                    ...
                    <td>
						<?PHP 
						$src_select_periode = $row_get_data_siswa["periode"]; 
