...
?>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <?PHP
		if($_GET["j"] == "toddler") 	{ $title_page	= "Toddler"; }
		else if($_GET["j"] == "pg") 	{ $title_page	= "Play Group"; }
		else if($_GET["j"] == "tka") 	{ $title_page	= "TK A"; }
		else if($_GET["j"] == "tkb") 	{ $title_page	= "TK B"; }
		else if($_GET["j"] == "sd") 	{ $title_page	= "SD"; }
		else if($_GET["j"] == "smp") 	{ $title_page	= "SMP"; }	
		?>
        <tr height="25">
            <td width="30"></td>
            ...
            <td>
                <table width="100%" border="1" cellpadding="0" cellspacing="0" id="text_normal_white" style="text-align:center;">
                    <tr height="25" bgcolor="#333333">
                        <td colspan="5">Tahun pelajaran: <?PHP include"include/period_refr_page.php"; ?><input type="hidden" name="src_period" value="<?PHP echo substr($_GET["period"],-11,11); ?>" /></td>
                    </tr>
                    <?PHP
					...
					?>
                        ...
                        */
						...
						if($_GET["j"] == "toddler") 	{ $class1_title	= "Toddler";	$page_title = "Toddler"; }
						else if($_GET["j"] == "pg") 	{ $class1_title	= "Play Group"; $page_title = "Play Group"; }
						else if($_GET["j"] == "tka") 	{ $class1_title	= "TK A"; 		$page_title = "TK A"; }
						else if($_GET["j"] == "tkb") 	{ $class1_title	= "TK B"; 		$page_title = "TK B"; }
						else if($_GET["j"] == "sd") 	{ $class1_title	= "Kelas 1"; 	$page_title = "SD"; }
						else if($_GET["j"] == "smp") 	{ $class1_title	= "Kelas 7"; 	$page_title = "SMP"; }	
						...
						<?PHP
                        if($_GET["j"] == "smp" || $_GET["j"] == "sd") {
							
							if($_GET["j"] == "sd") 			{ $class2_title	= "Kelas 2"; }
							else if($_GET["j"] == "smp") 	{ $class2_title	= "Kelas 8"; }
							/////////////////////////////////////////
							///////////////kelas 2///////////////////
							/////////////////////////////////////////
                    		...
                    		<?PHP
							if($_GET["j"] == "sd") 			{ $class3_title	= "Kelas 3"; }
							else if($_GET["j"] == "smp") 	{ $class3_title	= "Kelas 9"; }
							/////////////////////////////////////////
							///////////////kelas 3///////////////////
							/////////////////////////////////////////
	...
	$src_j	= mysql_real_escape_string($_GET["j"]);
            ...
            <td align="left">
                ...
                ?>
                    <tr height="30" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black">
                        ...
                        <td></td>
                        <td><a href="mainpage.php?pl=spp_sd_edit&per=<?PHP echo $row_load_spp["periode"]; ?>&lev=<?PHP echo $row_load_spp["jenjang"]; ?>"><img src="images/icon_edit.png" border="0" title="Edit data" /></a>&nbsp;&nbsp;<a href="mainpage.php?pl=spp_sd_delete&per=<?PHP echo $row_load_spp["periode"]; ?>&lev=<?PHP echo $row_load_spp["jenjang"]; ?>"><img src="images/icon_delete.png" border="0" title="Delete data"/></a></td>
                        <td></td>
                    </tr>	
                <?PHP
