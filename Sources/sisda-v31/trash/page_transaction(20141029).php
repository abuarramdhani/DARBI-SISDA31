                                        ...
                                        <tr height="20">
                                            ...
                                            <td colspan="4">
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
													...
													$src_check_arrear_spp 	= "select * from tunggakan where no_sisda = '$no_sisda_enc' and jenis_tunggakan = 'spp' and (status = '1' || status = '2')";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div style="vertical-align:top; font-family:verdana; font-size:10px; color:#FFCC00; ">Pastikan bahwa tahun yang anda pilih sesuai dengan tahun tagihan yang akan dibayarkan</div>
                                                        <select name="year_spp" id="year_spp" size="3" style="width: 150px" onchange="update_spp()">
                                                        <?PHP 
														$query_avai_year_spp	= mysqli_query($mysql_connect, $src_check_arrear_spp) or die(mysql_error());
														$cur_spp_year = date("Y"); ?>
                                                        <?PHP //<option selected>Pilih tahun ajaran</option> ?>
                                                        <?PHP 
														while($row_avai_year_spp = mysql_fetch_array($query_avai_year_spp)) {
														?>
                                                        <option value="<?PHP echo $row_avai_year_spp["periode"]." - ".substr($row_avai_year_spp["december"],2); ?>"><?PHP echo $row_avai_year_spp["periode"]; ?></option>
                                                        <?PHP
														}
														?>
                                                        </select>
                                            ...
                                            <td colspan="4">
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
														...
														?>
                                                        	<option value="jul-<?= $year_catering_auto; ?>-<?= $arrear_catering_jul_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] Juli</option>
                                                        <?PHP
															}
															
															if($arrear_catering_aug_auto[0] == 1 || $arrear_catering_aug_auto[0] == 2 || $arrear_catering_aug_auto[0] == 3) {
														?>
                                                        	<option value="aug-<?= $year_catering_auto; ?>-<?= $arrear_catering_aug_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] Agustus</option>
                                                        <?PHP
															
															}
															if($arrear_catering_sep_auto[0] == 1 || $arrear_catering_sep_auto[0] == 2 || $arrear_catering_sep_auto[0] == 3) {
														?>
                                                        	<option value="sep-<?= $year_catering_auto; ?>-<?= $arrear_catering_sep_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] September</option>
                                                        <?PHP
															
															}
															if($arrear_catering_oct_auto[0] == 1 || $arrear_catering_oct_auto[0] == 2 || $arrear_catering_oct_auto[0] == 3) {
														?>
                                                        	<option value="oct-<?= $year_catering_auto; ?>-<?= $arrear_catering_oct_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] Oktober</option>
                                                        <?PHP
															
															}
															if($arrear_catering_nov_auto[0] == 1 || $arrear_catering_nov_auto[0] == 2 || $arrear_catering_nov_auto[0] == 3) {
														?>
                                                        	<option value="nov-<?= $year_catering_auto; ?>-<?= $arrear_catering_nov_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] November</option>
                                                        <?PHP
															
															}
															if($arrear_catering_dec_auto[0] == 1 || $arrear_catering_dec_auto[0] == 2 || $arrear_catering_dec_auto[0] == 3) {
														?>
                                                        	<option value="dec-<?= $year_catering_auto; ?>-<?= $arrear_catering_dec_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] Desember</option>
                                                        <?PHP
															
															}
															if($arrear_catering_jan_auto[0] == 1 || $arrear_catering_jan_auto[0] == 2 || $arrear_catering_jan_auto[0] == 3) {
														?>
                                                        	<option value="jan-<?= $year_catering_auto; ?>-<?= $arrear_catering_jan_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] Januari</option>
                                                        <?PHP
															
															}
															if($arrear_catering_feb_auto[0] == 1 || $arrear_catering_feb_auto[0] == 2 || $arrear_catering_feb_auto[0] == 3) {
														?>
                                                        	<option value="feb-<?= $year_catering_auto; ?>-<?= $arrear_catering_feb_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] Februari</option>
                                                        <?PHP
															
															}
															if($arrear_catering_mar_auto[0] == 1 || $arrear_catering_mar_auto[0] == 2 || $arrear_catering_mar_auto[0] == 3) {
														?>
                                                        	<option value="mar-<?= $year_catering_auto; ?>-<?= $arrear_catering_mar_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] Maret</option>
                                                        <?PHP
															
															}
															if($arrear_catering_apr_auto[0] == 1 || $arrear_catering_apr_auto[0] == 2 || $arrear_catering_apr_auto[0] == 3) {
														?>
                                                        	<option value="apr-<?= $year_catering_auto; ?>-<?= $arrear_catering_apr_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] April</option>
                                                        <?PHP
															
															}
															if($arrear_catering_may_auto[0] == 1 || $arrear_catering_may_auto[0] == 2 || $arrear_catering_may_auto[0] == 3) {
														?>
                                                        	<option value="may-<?= $year_catering_auto; ?>-<?= $arrear_catering_may_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] May</option>
                                                        <?PHP
															
															}
															if($arrear_catering_jun_auto[0] == 1 || $arrear_catering_jun_auto[0] == 2 || $arrear_catering_jun_auto[0] == 3) {
														?>
                                                        	<option value="jun-<?= $year_catering_auto; ?>-<?= $arrear_catering_jun_auto[1]; ?>">[<?= $row_check_arrear_catering_auto["periode"]; ?>] June</option>
                                                        <?PHP
                                            	...
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
														...
														?>
                                                        	<option value="jul-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_jul_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] Juli</option>
                                                        <?PHP
															}
															
															if($arrear_antar_jemput_aug_auto[0] == 1 || $arrear_antar_jemput_aug_auto[0] == 2 || $arrear_antar_jemput_aug_auto[0] == 3) {
														?>
                                                        	<option value="aug-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_aug_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] Agustus</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_sep_auto[0] == 1 || $arrear_antar_jemput_sep_auto[0] == 2 || $arrear_antar_jemput_sep_auto[0] == 3) {
														?>
                                                        	<option value="sep-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_sep_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] September</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_oct_auto[0] == 1 || $arrear_antar_jemput_oct_auto[0] == 2 || $arrear_antar_jemput_oct_auto[0] == 3) {
														?>
                                                        	<option value="oct-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_oct_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] Oktober</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_nov_auto[0] == 1 || $arrear_antar_jemput_nov_auto[0] == 2 || $arrear_antar_jemput_nov_auto[0] == 3) {
														?>
                                                        	<option value="nov-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_nov_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] November</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_dec_auto[0] == 1 || $arrear_antar_jemput_dec_auto[0] == 2 || $arrear_antar_jemput_dec_auto[0] == 3) {
														?>
                                                        	<option value="dec-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_dec_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] Desember</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_jan_auto[0] == 1 || $arrear_antar_jemput_jan_auto[0] == 2 || $arrear_antar_jemput_jan_auto[0] == 3) {
														?>
                                                        	<option value="jan-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_jan_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] Januari</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_feb_auto[0] == 1 || $arrear_antar_jemput_feb_auto[0] == 2 || $arrear_antar_jemput_feb_auto[0] == 3) {
														?>
                                                        	<option value="feb-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_feb_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] Februari</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_mar_auto[0] == 1 || $arrear_antar_jemput_mar_auto[0] == 2 || $arrear_antar_jemput_mar_auto[0] == 3) {
														?>
                                                        	<option value="mar-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_mar_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] Maret</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_apr_auto[0] == 1 || $arrear_antar_jemput_apr_auto[0] == 2 || $arrear_antar_jemput_apr_auto[0] == 3) {
														?>
                                                        	<option value="apr-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_apr_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] April</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_may_auto[0] == 1 || $arrear_antar_jemput_may_auto[0] == 2 || $arrear_antar_jemput_may_auto[0] == 3) {
														?>
                                                        	<option value="may-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_may_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] May</option>
                                                        <?PHP
															
															}
															if($arrear_antar_jemput_jun_auto[0] == 1 || $arrear_antar_jemput_jun_auto[0] == 2 || $arrear_antar_jemput_jun_auto[0] == 3) {
														?>
                                                        	<option value="jun-<?= $year_antar_jemput_auto; ?>-<?= $arrear_antar_jemput_jun_auto[1]; ?>">[<?= $row_check_arrear_antar_jemput_auto["periode"]; ?>] June</option>
                                                        <?PHP
