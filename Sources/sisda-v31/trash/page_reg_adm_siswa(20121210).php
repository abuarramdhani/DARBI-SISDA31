    	...
    	<td>
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
            	...
            	<tr height="20">
                    ...
                    <td width="5"></td>
                    <td><input type="text" name="nama_siswa" size="35" /></td>
                </tr>
                <tr>
                ...
                <tr height="20">
                    ...
                    <td width="5"></td>
                    <td><input type="text" name="nama_sekolah_asal" size="35" /> 
                ...
                <tr height="20">
                    ...
                    <td width="5"></td>
                    <td>
						<select name="kelas" size="4" style="width: 150px"></select>
                    </td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
...
{ 
	...
	{
		alert('Field "Kategori status anak" hasus dipilih');
		return false;
	}
	/*
	...
	*/
	...
	{
		alert('Field "Asal sekolah tidak" boleh kosong');
		return false;
	}
	...
	if(document.reg_adm_siswa.kelas.value == "")
	{
		alert('Field "Kelas" tidak boleh kosong');
		return false;
	}
