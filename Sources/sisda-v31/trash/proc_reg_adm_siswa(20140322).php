...
if(isset($_SESSION["id"]) && $_SESSION["privilege"] == "2") {
	...
	if($query_insert_data_finance) {
		...
		$src_insert_pengembangan	= "insert into tunggakan (no_sisda, periode, jenis_tunggakan, nominal_tunggakan) values ('$cur_no_sisda','$enc_periode','biaya_masuk','$enc_sub_total_bima')";
		...
		if($query_insert_pengembangan) {
				...
				*/
				...
				for($i=0; $i<=$num_month; $i++) {			
					if($i == 1) { 
						...
						if($current_month == $i) { $val_july = "1-".$enc_sub_total_spp; } else { $val_july = "2-".$enc_sub_total_spp; }
					}
					if($i == 2) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_august = "1-".$enc_sub_total_spp; } else { $val_august = "2-".$enc_sub_total_spp; }
					}
					if($i == 3) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_september = "1-".$enc_sub_total_spp; } else { $val_september = "2-".$enc_sub_total_spp; }
					}
					if($i == 4) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_october = "1-".$enc_sub_total_spp; } else { $val_october = "2-".$enc_sub_total_spp; }
					}
					if($i == 5) { 
						//echo "current_month:".$current_month." num_month:".	$i."<br>";				
						if($current_month == $i) { $val_november = "1-".$enc_sub_total_spp; } else { $val_november = "2-".$enc_sub_total_spp; }
					}	
					if($i == 6) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_december = "1-".$enc_sub_total_spp; } else { $val_december = "2-".$enc_sub_total_spp; }
					}
					if($i == 7) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_january = "1-".$enc_sub_total_spp; } else { $val_january = "2-".$enc_sub_total_spp; }
					}
					if($i == 8) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_february = "1-".$enc_sub_total_spp; } else { $val_february = "2-".$enc_sub_total_spp; }
					}
					if($i == 9) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_march = "1-".$enc_sub_total_spp; } else { $val_march = "2-".$enc_sub_total_spp; }
					}	
					if($i == 10) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_april = "1-".$enc_sub_total_spp; } else { $val_april = "2-".$enc_sub_total_spp; }
					}	
					if($i == 11) {
						//echo "current_month:".$current_month." num_month:".	$i."<br>"; 				
						if($current_month == $i) { $val_may = "1-".$enc_sub_total_spp; } else { $val_may = "2-".$enc_sub_total_spp; }
					}	
					if($i == 12) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_june = "1-".$enc_sub_total_spp; } else { $val_june = "2-".$enc_sub_total_spp; }
					}		
				}
			}
			...
			if($query_insert_spp) {
				...
				$redirect_url	= "mainpage.php?pl=reg_adm_siswa";
