...
if(isset($_SESSION["id"]) && $_SESSION["privilege"] == "2") {
	...
	if(!empty($periode)) {
		...
		if($num_check_exist != 0) {
			...
			$src_nominal481 	= htmlspecialchars($_POST["tod_penga_dafultka"]);			
			$src_nominal482 	= htmlspecialchars($_POST["pgx_penga_dafultka"]);
			$src_nominal483 	= htmlspecialchars($_POST["pgx_kegia_dafultka"]);
			$src_nominal484 	= htmlspecialchars($_POST["pgx_peral_dafultka"]);
			$src_nominal485 	= htmlspecialchars($_POST["pgx_serag_dafultka"]);
			$src_nominal486		= htmlspecialchars($_POST["pgx_paket_dafultka"]);			
			$src_nominal487 	= htmlspecialchars($_POST["tka_penga_dafultka"]);
			$src_nominal488 	= htmlspecialchars($_POST["tka_kegia_dafultka"]);
			$src_nominal489		= htmlspecialchars($_POST["tka_peral_dafultka"]);
			$src_nominal490 	= htmlspecialchars($_POST["tka_serag_dafultka"]);
			$src_nominal491		= htmlspecialchars($_POST["tka_paket_dafultka"]);			
			$src_nominal492 	= htmlspecialchars($_POST["tkb_penga_dafultka"]);
			$src_nominal493		= htmlspecialchars($_POST["tkb_kegia_dafultka"]);
			$src_nominal494 	= htmlspecialchars($_POST["tkb_peral_dafultka"]);
			$src_nominal495		= htmlspecialchars($_POST["tkb_serag_dafultka"]);
			$src_nominal496 	= htmlspecialchars($_POST["tkb_paket_dafultka"]);			
			$src_nominal497		= htmlspecialchars($_POST["sdx_penga_dafultka"]);
			$src_nominal498		= htmlspecialchars($_POST["sdx_serag_dafultka"]);			
			$src_nominal499		= htmlspecialchars($_POST["smp_penga_dafultka"]);
			$src_nominal500 	= htmlspecialchars($_POST["smp_serag_dafultka"]);
			...
			$src_nominal501 	= htmlspecialchars($_POST["tod_penga_dafultkb"]);			
			$src_nominal502 	= htmlspecialchars($_POST["pgx_penga_dafultkb"]);
			$src_nominal503 	= htmlspecialchars($_POST["pgx_kegia_dafultkb"]);
			$src_nominal504 	= htmlspecialchars($_POST["pgx_peral_dafultkb"]);
			$src_nominal505 	= htmlspecialchars($_POST["pgx_serag_dafultkb"]);
			$src_nominal506		= htmlspecialchars($_POST["pgx_paket_dafultkb"]);			
			$src_nominal507 	= htmlspecialchars($_POST["tka_penga_dafultkb"]);
			$src_nominal508 	= htmlspecialchars($_POST["tka_kegia_dafultkb"]);
			$src_nominal509		= htmlspecialchars($_POST["tka_peral_dafultkb"]);
			$src_nominal510 	= htmlspecialchars($_POST["tka_serag_dafultkb"]);
			$src_nominal511		= htmlspecialchars($_POST["tka_paket_dafultkb"]);			
			$src_nominal512 	= htmlspecialchars($_POST["tkb_penga_dafultkb"]);
			$src_nominal513		= htmlspecialchars($_POST["tkb_kegia_dafultkb"]);
			$src_nominal514 	= htmlspecialchars($_POST["tkb_peral_dafultkb"]);
			$src_nominal515		= htmlspecialchars($_POST["tkb_serag_dafultkb"]);
			$src_nominal516 	= htmlspecialchars($_POST["tkb_paket_dafultkb"]);			
			$src_nominal517		= htmlspecialchars($_POST["sdx_penga_dafultkb"]);
			$src_nominal518		= htmlspecialchars($_POST["sdx_serag_dafultkb"]);			
			$src_nominal519		= htmlspecialchars($_POST["smp_penga_dafultkb"]);
			$src_nominal520 	= htmlspecialchars($_POST["smp_serag_dafultkb"]);
			...
			//You know boy,... sometimes, we dont know why, Mr Oman/Mr Roberto bagyo, ask administrator to delete some row from database, in many cases
			//But in this case. it's not that simple. because we have to keep the sequence of id, i mean the auto_increment.
			
			//If you do the deletion, you auto_increment will mess. it's an armagedon for our system hehehehehe
			
			//we have to unsure that the auto_increment increase ascendingly and there should be no data skipped.
			//For example: 1,2,3,6,7,8,9,10 -->4 and 5 are lost
			//Or id value increase descendingly
