      ...
      <table border="0" cellpadding="0" cellspacing="0">            	
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="20">
                    ...
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" name="zakat_mal" size="35" <?PHP if(!empty($_POST["zakat_mal"])) { echo "value=".$_POST["zakat_mal"].""; }  ?>  /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
                <tr height="20">
                    ...
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" name="zakat_profesi" size="35" <?PHP if(!empty($_POST["zakat_profesi"])) { echo "value=".$_POST["zakat_profesi"].""; }  ?>  /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
                <tr height="20">
                    ...
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" name="infaq_shodaqoh" size="35" <?PHP if(!empty($_POST["infaq_shodaqoh"])) { echo "value=".$_POST["infaq_shodaqoh"].""; }  ?>  /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
                <tr height="20">
                    ...
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" name="wakaf" size="35" <?PHP if(!empty($_POST["wakaf"])) { echo "value=".$_POST["wakaf"].""; }  ?>  /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
                <tr height="20">
                    ...
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" name="lain_lain" size="35" <?PHP if(!empty($_POST["lain_lain"])) { echo "value=".$_POST["lain_lain"].""; }  ?>  /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
