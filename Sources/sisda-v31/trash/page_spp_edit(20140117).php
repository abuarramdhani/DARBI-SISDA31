...
?>
	...
	$the_j_enc			= mysql_real_escape_string($src_j);
	...
	$num_get_spp	= mysql_num_rows($query_get_spp);
	...
	while($row_get_spp	= mysql_fetch_array($query_get_spp)) {
		...
		if($row_get_spp["tingkat"] == "toddler" || $row_get_spp["tingkat"] == "pg" || $row_get_spp["tingkat"] == "tka" || $row_get_spp["tingkat"] == "tkb" || $row_get_spp["tingkat"] == "1" || $row_get_spp["tingkat"] == "7") {						
			...
			if($row_get_spp["ket_disc"] == ($lev1_1_min_periode.$lev1_1_max_periode) && $row_get_spp["item_byr"] == "add") {
		...
		if($src_j == "smp" || $src_j == "sd") {
			...
			if($row_get_spp["tingkat"] == "2" || $row_get_spp["tingkat"] == "8") {
				...
				if($row_get_spp["ket_disc"] == ($lev2_1_min_periode.$lev2_1_max_periode) && $row_get_spp["item_byr"] == "add") {
				...
				if($row_get_spp["ket_disc"] == ($lev2_2_min_periode.$lev2_2_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["tingkat"] == "3" || $row_get_spp["tingkat"] == "9") {
				...
				if($row_get_spp["ket_disc"] == ($lev3_1_min_periode.$lev3_1_max_periode) && $row_get_spp["item_byr"] == "add") {
				...
				if($row_get_spp["ket_disc"] == ($lev3_2_min_periode.$lev3_2_max_periode) && $row_get_spp["item_byr"] == "add") {
				...
				if($row_get_spp["ket_disc"] == ($lev3_3_min_periode.$lev3_3_max_periode) && $row_get_spp["item_byr"] == "add") {
		...
		if($row_get_spp["tingkat"] == "4") {
			...
			if($row_get_spp["ket_disc"] == ($lev4_1_min_periode.$lev4_1_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev4_2_min_periode.$lev4_2_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev4_3_min_periode.$lev4_3_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev4_4_min_periode.$lev4_4_max_periode) && $row_get_spp["item_byr"] == "add") {
		...
		if($row_get_spp["tingkat"] == "5") {
			...
			if($row_get_spp["ket_disc"] == ($lev5_1_min_periode.$lev5_1_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev5_2_min_periode.$lev5_2_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev5_3_min_periode.$lev5_3_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev5_4_min_periode.$lev5_4_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev5_5_min_periode.$lev5_5_max_periode) && $row_get_spp["item_byr"] == "add") {
		...
		if($row_get_spp["tingkat"] == "6") {
			...
			if($row_get_spp["ket_disc"] == ($lev6_1_min_periode.$lev6_1_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev6_2_min_periode.$lev6_2_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev6_3_min_periode.$lev6_3_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev6_4_min_periode.$lev6_4_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev6_5_min_periode.$lev6_5_max_periode) && $row_get_spp["item_byr"] == "add") {
			...
			if($row_get_spp["ket_disc"] == ($lev6_6_min_periode.$lev6_6_max_periode) && $row_get_spp["item_byr"] == "add") {
            ...
            <td>
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" id="text_normal_white" style="text-align:center;">
                    <tr height="25" bgcolor="#333333">
                        <td colspan="5">Tahun pelajaran: <input type="text" size="10" readonly="readonly" name="periode" value="<?PHP echo $the_periode; ?>" /><input type="hidden" name="src_periode" value="<?PHP echo $the_periode; ?>" /></td>
                    </tr>
                    <?PHP
