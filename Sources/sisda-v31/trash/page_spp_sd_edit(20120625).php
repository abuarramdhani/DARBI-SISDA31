    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
    	<tr>
            ...
            <td>
                <table width="100%" border="1" cellpadding="0" cellspacing="0" id="text_normal_white" style="text-align:center;">
					...
					?>
                                <tr height="25" bgcolor="#83736c">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_1_per1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-per1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP
							}
							if($row_get_spp["ket_disc"] == ($lev1_1_min_period.$lev1_1_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_1_per1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-per1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP
							}
							if($row_get_spp["ket_disc"] == ($lev1_1_min_period.$lev1_1_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_1_per1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-per1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>
                    			<tr height="25" bgcolor="#83736c">
                                    <td>Anak guru</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_1_angu_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-angu-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "ict") {
					?>								               
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_1_angu_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-angu-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "add") {
					?>
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_1_angu_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-angu-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>
                                <tr height="25" bgcolor="#83736c">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_1_dis1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_1_dis1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "add") {
					?>
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_1_dis1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>
                    			<tr height="25" bgcolor="#83736c">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_1_dis2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_1_dis2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_1_dis2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>
                    			<tr height="25" bgcolor="#83736c">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_1_dis3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_1_dis3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "add") {
					?>               
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_1_dis3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="1-dis3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP		
							}
						}
					...
					?>
                    			 <tr height="25" bgcolor="#8a6c66">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_2_per1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-per1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev2_1_min_period.$lev2_1_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>       
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_2_per1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-per1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev2_1_min_period.$lev2_1_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_2_per1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-per1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>            
                                <tr height="25" bgcolor="#8a6c66">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_2_per2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-per2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev2_2_min_period.$lev2_2_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_2_per2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-per2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev2_2_min_period.$lev2_2_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_2_per2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-per2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#8a6c66">
                                    <td>Anak guru</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_2_angu_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-angu-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_2_angu_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-angu-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_2_angu_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-angu-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#8a6c66">
                                    <td>Discount khusus 1</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_2_dis1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "ict") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_2_dis1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_2_dis1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "spp") {
					?>            	
                                <tr height="25" bgcolor="#8a6c66">
                                    <td>Discount khusus 2</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_2_dis2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_2_dis2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_2_dis2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "spp") {
					?>             	
                                <tr height="25" bgcolor="#8a6c66">
                                    <td>Discount khusus 3</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_2_dis3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_2_dis3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_2_dis3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="2-dis3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>	
                    <?PHP
							}
						}
					...
					?>
                    			<tr height="25" bgcolor="#8d6774">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_3_per1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev3_1_min_period.$lev3_1_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                   
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_3_per1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev3_1_min_period.$lev3_1_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_3_per1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>            
                                <tr height="25" bgcolor="#8d6774">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_3_per2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev3_2_min_period.$lev3_2_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_3_per2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev3_2_min_period.$lev3_2_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_3_per2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>            
                                <tr height="25" bgcolor="#8d6774">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_3_per3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev3_3_min_period.$lev3_3_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_3_per3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev3_3_min_period.$lev3_3_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_3_per3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-per3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "spp") {
					?>             
                                <tr height="25" bgcolor="#8d6774">
                                    <td>Anak guru</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_3_angu_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-angu-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_3_angu_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-angu-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_3_angu_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-angu-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#8d6774">
                                    <td>Discount khusus 1</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_3_dis1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_3_dis1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "add") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_3_dis1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#8d6774">
                                    <td>Discount khusus 2</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_3_dis2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_3_dis2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_3_dis2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#8d6774">
                                    <td>Discount khusus 3</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_3_dis3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_3_dis3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_3_dis3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="3-dis3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
					...
					?>
                    			<tr height="25" bgcolor="#7f7085">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_4_per1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev4_1_min_period.$lev4_1_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_4_per1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev4_1_min_period.$lev4_1_max_period) && $row_get_spp["item_byr"] == "add") {
					?>               
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_4_per1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>            
                                <tr height="25" bgcolor="#7f7085">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_4_per2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev4_2_min_period.$lev4_2_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_4_per2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev4_2_min_period.$lev4_2_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_4_per2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>             
                                <tr height="25" bgcolor="#7f7085">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_4_per3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev4_3_min_period.$lev4_3_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_4_per3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev4_3_min_period.$lev4_3_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_4_per3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>             
                                <tr height="25" bgcolor="#7f7085">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_4_per4_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per4-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev4_4_min_period.$lev4_4_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_4_per4_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per4-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev4_4_min_period.$lev4_4_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_4_per4_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-per4-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#7f7085">
                                    <td>Anak guru</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_4_angu_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-angu-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_4_angu_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-angu-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_4_angu_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-angu-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#7f7085">
                                    <td>Discount khusus 1</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_4_dis1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_4_dis1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_4_dis1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#7f7085">
                                    <td>Discount khusus 2</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_4_dis2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_4_dis2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "add") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_4_dis2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#7f7085">
                                    <td>Discount khusus 3</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_4_dis3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_4_dis3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_4_dis3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="4-dis3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP
							}
						}
					...
					?>
                    			 <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_per1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_1_min_period.$lev5_1_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_per1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_1_min_period.$lev5_1_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_per1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>            
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_per2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_2_min_period.$lev5_2_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_per2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_2_min_period.$lev5_2_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_per2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>              
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_per3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_3_min_period.$lev5_3_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_per3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_3_min_period.$lev5_3_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_per3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>              
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_per4_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per4-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_4_min_period.$lev5_4_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_per4_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per4-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_4_min_period.$lev5_4_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_per4_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per4-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
						}
					...
					?>              
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_per5_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per5-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_5_min_period.$lev5_5_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_per5_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per5-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev5_5_min_period.$lev5_5_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_per5_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-per5-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "spp") {
					?>             
                                <tr height="25" bgcolor="#58778a">
                                    <td>Anak guru</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_angu_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-angu-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                   	<?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "ict") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_angu_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-angu-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "add") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_angu_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-angu-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#58778a">
                                    <td>Discount khusus 1</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_dis1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_dis1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_dis1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#58778a">
                                    <td>Discount khusus 2</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_dis2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_dis2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "add") {
					?>               
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_dis2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#58778a">
                                    <td>Discount khusus 3</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_5_dis3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_5_dis3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_5_dis3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="5-dis3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP
							}	
						}
					...
					?>
                    			<tr height="25" bgcolor="#668285">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_per1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_1_min_period.$lev6_1_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                  
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_per1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_1_min_period.$lev6_1_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_per1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>             
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_per2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_2_min_period.$lev6_2_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_per2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_2_min_period.$lev6_2_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_per2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>            
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_per3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_3_min_period.$lev6_3_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_per3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_3_min_period.$lev6_3_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_per3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>             
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_per4_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per4-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_4_min_period.$lev6_4_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_per4_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per4-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_4_min_period.$lev6_4_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_per4_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per4-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP
							}
					...
					?>             
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_per5_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per5-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_5_min_period.$lev6_5_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_per5_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per5-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_5_min_period.$lev6_5_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_per5_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per5-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
					...
					?>             
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_per6_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per6-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_6_min_period.$lev6_6_max_period) && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_per6_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per6-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == ($lev6_6_min_period.$lev6_6_max_period) && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_per6_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-per6-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "spp") {
					?>             
                                <tr height="25" bgcolor="#668285">
                                    <td>Anak guru</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_angu_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-angu-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_angu_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-angu-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "angu" && $row_get_spp["item_byr"] == "add") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_angu_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-angu-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "spp") {
					?>            
                                <tr height="25" bgcolor="#668285">
                                    <td>Discount khusus 1</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_dis1_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis1-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_dis1_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis1-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis1" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_dis1_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis1-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "spp") {
					?>             
                                <tr height="25" bgcolor="#668285">
                                    <td>Discount khusus 2</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_dis2_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis2-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "ict") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_dis2_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis2-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis2" && $row_get_spp["item_byr"] == "add") {
					?>                
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_dis2_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis2-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "spp") {
					?>              
                                <tr height="25" bgcolor="#668285">
                                    <td>Discount khusus 3</td>
                                    <td><?PHP if($row_get_spp["item_byr"] == "spp") { $var_6_dis3_spp = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis3-spp" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "ict") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "ict") { $var_6_dis3_ict = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis3-ict" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                    <?PHP	
							}
							if($row_get_spp["ket_disc"] == "dis3" && $row_get_spp["item_byr"] == "add") {
					?>                 
                                    <td><?PHP if($row_get_spp["item_byr"] == "add") { $var_6_dis3_add = $row_get_spp["nominal"]; ?><input type="text" size="10" name="6-dis3-add" value="<?PHP echo $row_get_spp["nominal"]; ?>" onkeypress="return checkIt(event)"/><?PHP } ?></td>
                                </tr>
                    <?PHP
							}
						}
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" id="text_normal_white" style="text-align:center;">
                    <tr height="25" bgcolor="#333333">
                        <td colspan="5">Tahun pelajaran: <?PHP include"include/period_refr_page_sd.php"; ?><input type="hidden" name="level" value="sd" /><input type="hidden" name="src_period" value="<?PHP echo substr($_GET["per"],-11,11); ?>" /></td>
                    </tr>
                    <?PHP
