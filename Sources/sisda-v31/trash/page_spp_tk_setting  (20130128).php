...
?>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="25">
            <td width="30"></td>
            <td id="text_title_page1" align="center"><h2 style="padding:0px;">--- Play Group/TK A/TK B ---</h2>Pengaturan Nominal SPP, ICT dan pembayaran lainnya per periode</td>
            <td width="30"></td>
        </tr>
        <tr>
            <td></td>
    ...
    <form method="post" name="set_spp" action="engine.php?case=spp_tk_setting">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr>
            <td width="30"></td>
            <td>
                <table width="100%" border="1" cellpadding="0" cellspacing="0" id="text_normal_white" style="text-align:center;">
                    <tr height="25" bgcolor="#333333">
                        <td colspan="5">Tahun pelajaran: <?PHP include"include/period_refr_page_tk.php"; ?><input type="hidden" name="level" value="tk" /><input type="hidden" name="src_period" value="<?PHP echo substr($_GET["period"],-11,11); ?>" /></td>
                    </tr>
                    <?PHP
    ...
    $src_load_spp		= "select distinct periode,level from set_spp where level = 'tk' order by periode limit $the_limit,$show_per_page ";
    
    //but also, we need to select all record. it will be used to define the paging list.
    $src_load_spp_all	= "select distinct periode,level from set_spp where level = 'tk'";
        ...
        <tr>
            ...
            <td align="left">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">            	
                    ...
                    <tr>
                    	<td colspan="3" align="left" id="text_title_index1">Daftar Setting SPP untuk level Play Group/TK A/TK B</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        for($i = 1; $i <= $all_page; $i++) {
                            if($i == $p) {
                                ...
                                echo "<span id='paging'><a href=\"?pl=setting_spp_tk&p=$i\" >$i</a></span> ";
                            }
                        }
                        ?>
                        </td>
                ...
                ?>
                    <tr height="30" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black">
                        ...
                        <td></td>
                        <td><a href="mainpage.php?pl=spp_tk_edit&per=<?PHP echo $row_load_spp["periode"]; ?>&lev=<?PHP echo $row_load_spp["level"]; ?>"><img src="images/icon_edit.png" border="0" title="Edit data" /></a>&nbsp;&nbsp;<a href="mainpage.php?pl=spp_tk_delete&per=<?PHP echo $row_load_spp["periode"]; ?>&lev=<?PHP echo $row_load_spp["level"]; ?>"><img src="images/icon_delete.png" border="0" title="Delete data"/></a></td>
                        <td></td>
                    </tr>	
                <?PHP
