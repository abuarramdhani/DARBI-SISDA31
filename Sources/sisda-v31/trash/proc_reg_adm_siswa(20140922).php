				...
				*/
				...
				for($i=0; $i<=$num_month; $i++) {			
					if($i == 1) { 
						...
						if($current_month == $i) { $val_july = "1-".$enc_sub_total_spp; } else { $val_july = "4-0"; }
					}
					if($i == 2) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_august = "1-".$enc_sub_total_spp; } else { $val_august = "4-0"; }
					}
					if($i == 3) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_september = "1-".$enc_sub_total_spp; } else { $val_september = "4-0"; }
					}
					if($i == 4) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_october = "1-".$enc_sub_total_spp; } else { $val_october = "4-0"; }
					}
					if($i == 5) { 
						//echo "current_month:".$current_month." num_month:".	$i."<br>";				
						if($current_month == $i) { $val_november = "1-".$enc_sub_total_spp; } else { $val_november = "4-0"; }
					}	
					if($i == 6) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_december = "1-".$enc_sub_total_spp; } else { $val_december = "4-0"; }
					}
					if($i == 7) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_january = "1-".$enc_sub_total_spp; } else { $val_january = "4-0"; }
					}
					if($i == 8) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_february = "1-".$enc_sub_total_spp; } else { $val_february = "4-0"; }
					}
					if($i == 9) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_march = "1-".$enc_sub_total_spp; } else { $val_march = "4-0"; }
					}	
					if($i == 10) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_april = "1-".$enc_sub_total_spp; } else { $val_april = "4-0"; }
					}	
					if($i == 11) {
						//echo "current_month:".$current_month." num_month:".	$i."<br>"; 				
						if($current_month == $i) { $val_may = "1-".$enc_sub_total_spp; } else { $val_may = "4-0"; }
					}	
					if($i == 12) { 	
						//echo "current_month:".$current_month." num_month:".	$i."<br>";			
						if($current_month == $i) { $val_june = "1-".$enc_sub_total_spp; } else { $val_june = "4-0"; }
					}		
				}
			}
