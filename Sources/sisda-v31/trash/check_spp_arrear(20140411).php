...
if($cur_month == "july") 		{ $month_checked = "june"; 		$month_cataj_checked = "jun_cataj";	$cur_month_cataj = "jul_cataj";	$year_checked = $last_edu_year; }
if($cur_month == "august") 		{ $month_checked = "july"; 		$month_cataj_checked = "jul_cataj";	$cur_month_cataj = "aug_cataj";	$year_checked = $edu_year; }
if($cur_month == "september") 	{ $month_checked = "august"; 	$month_cataj_checked = "aug_cataj";	$cur_month_cataj = "sep_cataj";	$year_checked = $edu_year; }
if($cur_month == "october") 	{ $month_checked = "september"; $month_cataj_checked = "sep_cataj";	$cur_month_cataj = "oct_cataj";	$year_checked = $edu_year; }
if($cur_month == "november") 	{ $month_checked = "october"; 	$month_cataj_checked = "oct_cataj";	$cur_month_cataj = "nov_cataj";	$year_checked = $edu_year; }
if($cur_month == "december") 	{ $month_checked = "november"; 	$month_cataj_checked = "nov_cataj";	$cur_month_cataj = "dec_cataj";	$year_checked = $edu_year; }
if($cur_month == "january") 	{ $month_checked = "december"; 	$month_cataj_checked = "dec_cataj";	$cur_month_cataj = "jan_cataj";	$year_checked = $edu_year; }
if($cur_month == "february") 	{ $month_checked = "january"; 	$month_cataj_checked = "jan_cataj";	$cur_month_cataj = "feb_cataj";	$year_checked = $edu_year; }
if($cur_month == "march") 		{ $month_checked = "february"; 	$month_cataj_checked = "feb_cataj";	$cur_month_cataj = "mar_cataj";	$year_checked = $edu_year; }
if($cur_month == "april") 		{ $month_checked = "march"; 	$month_cataj_checked = "mar_cataj";	$cur_month_cataj = "apr_cataj";	$year_checked = $edu_year; }
if($cur_month == "may") 		{ $month_checked = "april"; 	$month_cataj_checked = "apr_cataj";	$cur_month_cataj = "may_cataj";	$year_checked = $edu_year; }
if($cur_month == "june") 		{ $month_checked = "may"; 		$month_cataj_checked = "may_cataj";	$cur_month_cataj = "jun_cataj";	$year_checked = $edu_year; }
...
$src_get_tunggakan		= 	"select no_sisda, $month_checked, $month_cataj_checked, $cur_month, $cur_month_cataj, jenis_tunggakan from tunggakan where 
