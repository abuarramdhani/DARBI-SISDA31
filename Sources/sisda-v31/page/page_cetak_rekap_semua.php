...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan="2" id="text_normal_black" align="center" height="35"><span style="font-size:24px; font-weight:bold;">Rekapitulasi Transaksi</span></td>
    </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
    	...
    	<td align="center">
        	...
        	<table width="100%" border="0" cellpadding="4" cellspacing="1" style="border: 1px blue dotted; font-size:10px;">  
            	<tr height="30">  
                    ...
                    <td width="" bgcolor="#999999" id="cetak_rekap_putih" align="center">Biaya<br />masuk</td>
                    <td width="" bgcolor="#999999" id="cetak_rekap_putih" align="center">Daftar<br />ulang</td>
                    ...
                    <td width="" bgcolor="#999999" id="cetak_rekap_putih" align="center">Catering</td>
                    <td width="" bgcolor="#999999" id="cetak_rekap_putih" align="center">Antar jemput</td>
                    <td width="" bgcolor="#999999" id="cetak_rekap_putih" align="center">Rumah berbagi</td>
                    <td width="" bgcolor="#999999" id="cetak_rekap_putih" align="center">School Support</td>
				...
				if($num_get_siswa_all != 0) {
					...
					$total_nom_ks_trs 			= "";
					$total_nom_catering_trs 	= "";
					$total_nom_antar_jemput_trs = "";
					$total_nom_ruba_trs 		= "";
					$total_nom_schspt_trs 		= "";
					$total_nom_all_trs 			= "";
					...
					while($get_siswa = mysql_fetch_array($query_get_siswa)) {
						...
						$nom_bima = 
									(
										...
										$get_siswa["pengembangan_bima"]+
										$get_siswa["kegiatan_bima"]+
										$get_siswa["peralatan_bima"]+
										$get_siswa["seragam_bima"]+
										$get_siswa["paket_bima"]
									);
									
						$nom_daful	= 
									(
									
										$get_siswa["kegiatan_daful"]+
										$get_siswa["peralatan_daful"]+
										$get_siswa["seragam_daful"]
							...
							$nom_ruba = 
									(
										...
										$get_siswa["zakat_mal_ruba"]+
										$get_siswa["zakat_profesi_ruba"]+
										$get_siswa["infaq_sho_ruba"]+
										$get_siswa["wakaf_ruba"]+
										$get_siswa["zakat_fitrah_ruba"]+
										$get_siswa["fidyah_ruba"]+
										$get_siswa["baksos_ramadhan_ruba"]+
										$get_siswa["qurban_ruba"]
									
									);	
									
							$src_schspt		= $get_siswa["school_support"];							
							$expl_schspt 	= explode(',',$src_schspt);
							$nom_schspt		= "";
							
							foreach($expl_schspt as $i_schspt => $result) {
							
								$i_schspt > 1;
								$nom_schspt = $nom_schspt + $result;
							}
					...
					<tr height="30">                
						...
						<td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP if($nom_bima == 0) { echo "0"; } else { echo "Rp ".number_format($nom_bima,0,",",".").",-"; } ?></td>                    
						<td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP if($nom_daful == 0) { echo "0"; } else { echo "Rp ".number_format($nom_daful,0,",",".").",-"; } ?></td>
						<td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP if($nom_spp == 0) { echo "0"; } else { echo "Rp ".number_format($nom_spp,0,",",".").",-"; } ?></td>
                        ...
                        <td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP if($get_siswa["catering"] == 0) { echo "0"; } else { echo "Rp ".number_format($get_siswa["catering"],0,",",".").",-"; } ?></td>
						<td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP if($get_siswa["antar_jemput"] == 0) { echo "0"; } else { echo "Rp ".number_format($get_siswa["antar_jemput"],0,",",".").",-"; } ?></td>
						<td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP if($nom_ruba == 0) { echo "0"; } else { echo "Rp ".number_format($nom_ruba,0,",",".").",-"; } ?></td>
                        <td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP if($nom_schspt == 0) { echo "0"; } else { echo "Rp ".number_format($nom_schspt,0,",",".").",-"; } ?></td>
						<td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP echo "Rp ".number_format($jmlh,0,",",".").",-";  ?></td>
					</tr>
					<?PHP
						
						$total_nom_bima_trs 				= $total_nom_bima_trs+$nom_bima;
						$total_nom_daful_trs 				= $total_nom_daful_trs+$nom_daful;
						$total_nom_spp_trs 					= $total_nom_spp_trs+$nom_spp;
						$total_nom_ks_trs 					= $total_nom_ks_trs+$get_siswa["ks_spp"];
						$total_nom_catering_trs 			= $total_nom_catering_trs+$get_siswa["catering"];
						$total_nom_antar_jemput_trs 		= $total_nom_antar_jemput_trs+$get_siswa["antar_jemput"];
						$total_nom_ruba_trs 				= $total_nom_ruba_trs+$nom_ruba;
						$total_nom_schspt_trs 				= $total_nom_schspt_trs+$nom_schspt;
					...
					?>
					<tr height="30">                
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="left" colspan="8"><b>Jumlah total:</b></td>
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="center"><?PHP if($total_nom_bima_trs == 0) { echo "0"; } else { echo "Rp ".number_format($total_nom_bima_trs,0,",",".").",-"; }?></td>
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="center"><?PHP if($total_nom_daful_trs == 0) { echo "0"; } else { echo "Rp ".number_format($total_nom_daful_trs,0,",",".").",-"; } ?></td>
						...
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="center"><?PHP if($total_nom_spp_trs == 0) { echo "0"; } else { echo "Rp ".number_format($total_nom_ks_trs,0,",",".").",-"; } ?></td>
                        <td width="" bgcolor="#333333" id="cetak_rekap_putih" align="center"><?PHP if($total_nom_catering_trs == 0) { echo "0"; } else { echo "Rp ".number_format($total_nom_catering_trs,0,",",".").",-"; } ?></td>
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="center"><?PHP if($total_nom_antar_jemput_trs == 0) { echo "0"; } else { echo "Rp ".number_format($total_nom_antar_jemput_trs,0,",",".").",-"; } ?></td>
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="center"><?PHP if($total_nom_ruba_trs == 0) { echo "0"; } else { echo "Rp ".number_format($total_nom_ruba_trs,0,",",".").",-"; } ?></td>
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="center"><?PHP if($total_nom_schspt_trs == 0) { echo "0"; } else { echo "Rp ".number_format($total_nom_schspt_trs,0,",",".").",-"; } ?></td>
...
<table width="1045" border="0" cellpadding="0" cellspacing="0">
	<tr height="20">
    	<td><input type="button" value="." onclick="window.location.href='<?= $darbi_url; ?>mainpage.php?pl=cetak_rekap';" style="background-color:#FFFFFF;"  /></td>
    </tr>
</table>
</body>
</html>