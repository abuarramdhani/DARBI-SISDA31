                    	...
                    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr height="20">
                                ...
                                <td bgcolor="" valign="top">
									...
									$check_pgtka		= mysql_fetch_array($query_check_pgtka);
									...
									if($check_pgtka["jenjang"] == "PG" || $check_pgtka["jenjang"] == "TK A") {
										...
										$num_check_pgtka_nextyear	= mysql_num_rows($query_check_pgtka_nextyear);
                                            ...
                                            <td colspan="4">                                            
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr height="30">
                                                        ...
                                                        <?PHP while($daftar_ulang_get_periode = mysql_fetch_array($query_daftar_ulang_get_periode)) {
														?>
