    ...
    */
    ...
    while($row_get_cat_adm_bi_ma	= mysql_fetch_array($query_get_cat_adm_bi_ma)) {
		...
		if($row_get_cat_adm_bi_ma["set_cat_adm"] == "dafultka") {
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="tka_kegia_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
		...
		if($row_get_cat_adm_bi_ma["set_cat_adm"] == "dafultkb") {
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="tkb_kegia_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
