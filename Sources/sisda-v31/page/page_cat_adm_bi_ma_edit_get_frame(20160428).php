    ...
    */
    ...
    while($row_get_cat_adm_bi_ma	= mysql_fetch_array($query_get_cat_adm_bi_ma)) {
		...
		if($row_get_cat_adm_bi_ma["set_cat_adm"] == "dafultka") {
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
                <td><input type="text" name="tka_peral_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="tka_serag_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>	
