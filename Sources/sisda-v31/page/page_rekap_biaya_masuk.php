...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="25">
    	<td width="30"></td>
        <td id="text_title_page1" align="center">Rekapitulasi Biaya Masuk</td>
        <td width="30"></td>
    </tr>
    <tr>
    	<td></td>
    ...
    <tr>
    	...
    	<td align="center">
            ...
            <form name="search" method="post" action="?pl=rekap_biaya_masuk">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
            	...
            	<tr height="20">
					...
					*/
					?>
                    <form method="post" action="mainpage.php?pl=rekap_biaya_masuk">
        	...
        	<table width="100%" border="0" cellpadding="5" cellspacing="1" style="border: 1px blue dotted;">  
            	<tr height="30">  
                    ...
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Pengembangan</td>
                    ...
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Paket</td>
                </tr>
                <?PHP
                ...
                <tr height="30">                
                    ...
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["pengembangan_bima"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["pengembangan_bima"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["kegiatan_bima"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["kegiatan_bima"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["peralatan_bima"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["peralatan_bima"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["seragam_bima"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["seragam_bima"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["paket_bima"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["paket_bima"],0,",",".").",-"; } ?></td>
                </tr>
                <?PHP
					if($bg	== "#ffffff") {
						$bg	= "#f1f1f1";
