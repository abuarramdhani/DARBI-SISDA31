    ...
    <tr>
    	...
    	<td>
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <!--<td width="200" id="text_normal_black" colspan="4">
					<!-- Go to the edit page -->
					<!--<input style="height:25; font-size:11px;" type="submit" value="Edit Data Siswa" onClick="return OnButton1()"/></td>-->
                </tr>                
                <tr>
                ...
                <tr height="20">
                    ...
                    <td width="5"></td>
                    <td>
                    <input type="text" name="kat_status_anak" size="35" value="<?PHP echo $_POST["kat_status_anak"]; ?>" readonly="readonly"/>
                    <?PHP
					$cur_kat_stat_anak = $_POST["kat_status_anak"];
					
                    if($cur_kat_stat_anak == "khusus") {
					?>
                    	<input type="text" name="value_khusus" size="35" value="<?PHP echo $_POST["value_khusus"]; ?>" readonly="readonly" />
                    <?PHP
					}
					?>
                    </td>
                ...
                <tr height="20">
                	<td width="10" bgcolor="#999999"></td>
                    <td width="200" bgcolor="#999999" id="text_normal_white">Periode (bulan / tahun)</td>
                    <td width="5"></td>
                    <td><input type="text" name="bulan_terdaftar" size="1" value="<?PHP echo $_POST["bulan_terdaftar"]; ?>" readonly="readonly" /> / <input type="text" name="periode" size="35"  value="<?PHP echo $_POST["periode"]; ?>" readonly="readonly"/></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0">            	
                <tr height="20">
                  ...
                  <td width="200" bgcolor="#333333" id="text_normal_white">Kategori administrasi</td>
                    ...
                    <option value="6" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "6") { ?> selected="selected"<?PHP }} ?>>Umum bersamaan dengan Saudara Kandung + Grade B</option>
                    <option value="7" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "7") { ?> selected="selected"<?PHP }} ?>>Asal Darbi</option>
                    <option value="8" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "8") { ?> selected="selected"<?PHP }} ?>>Asal Darbi + Grade A</option>
                    <option value="9" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "9") { ?> selected="selected"<?PHP }} ?>>Asal Darbi + Grade B</option>
                    <option value="10" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "10") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-1</option>
                    <option value="11" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "11") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-2</option>
                    <option value="12" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "12") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-3, dst</option>
                    <option value="13" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "13") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-1 + Grade A</option>
                    <option value="14" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "14") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-1 + Grade B</option>
                    <option value="15" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "15") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-2 + Grade A</option>
                    <option value="16" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "16") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-2 + Grade B</option>
                    <option value="17" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "17") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-3, dst + Grade A</option>
                    <option value="18" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "18") { ?> selected="selected"<?PHP }} ?>>Anak pegawai ke-3, dst + Grade B</option>
                    <option value="19" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "19") { ?> selected="selected"<?PHP }} ?>>Siswa pindahan ke Toddler semester II</option>
                    <option value="20" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "20") { ?> selected="selected"<?PHP }} ?>>Siswa pindahan ke PG/TK A/TK B Semester II</option>
                    <option value="21" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "21") { ?> selected="selected"<?PHP }} ?>>Siswa pindahan ke SD 3-4</option>
                    <option value="22" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "22") { ?> selected="selected"<?PHP }} ?>>Siswa pindahan ke SD 5-6</option>
                    <option value="23" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "23") { ?> selected="selected"<?PHP }} ?>>Siswa pindahan ke SMP 8</option>
                    <option value="24" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "24") { ?> selected="selected"<?PHP }} ?>>Siswa pindahan ke SMP 9</option>
                    <option value="25" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "25") { ?> selected="selected"<?PHP }} ?>>Daftar ulang siswa TK A</option>
                    <option value="26" <?PHP if(!empty($_POST["disc_cat_adm"])) { if($_POST["disc_cat_adm"] == "26") { ?> selected="selected"<?PHP }} ?>>Daftar ulang siswa TK B</option>
                    </select>                    
                    </td>
                </tr>
                <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0">            	
                <tr height="20">
					...
					<script>
						...
						{
							//iMa-7 Mei 2019
							//its just a declaring function, if this function is not written, it will
							//show an error message "function is not defined"
						}
					</script>
                </tr>
            </table>
            ...
            <?PHP
				...
				if($_POST["disc_cat_adm"] == 5) { $q = "umskgrab"; }
				if($_POST["disc_cat_adm"] == 6) { $q = "ubdskgrab"; } 
				if($_POST["disc_cat_adm"] == 7) { $q = "asdar"; } 
				if($_POST["disc_cat_adm"] == 8) { $q = "asdargraa"; }
				if($_POST["disc_cat_adm"] == 9) { $q = "asdargrab"; }
				if($_POST["disc_cat_adm"] == 10) { $q = "anpeg1"; }
				if($_POST["disc_cat_adm"] == 11) { $q = "anpeg2"; }
				if($_POST["disc_cat_adm"] == 12) { $q = "anpeg3"; }
				if($_POST["disc_cat_adm"] == 13) { $q = "anpeg1graa"; }
				if($_POST["disc_cat_adm"] == 14) { $q = "anpeg1grab"; }
				if($_POST["disc_cat_adm"] == 15) { $q = "anpeg2graa"; }
				if($_POST["disc_cat_adm"] == 16) { $q = "anpeg2grab"; }
				if($_POST["disc_cat_adm"] == 17) { $q = "anpeg3graa"; }
				if($_POST["disc_cat_adm"] == 18) { $q = "anpeg3grab"; } 
				if($_POST["disc_cat_adm"] == 19) { $q = "pintodsem2"; }
				if($_POST["disc_cat_adm"] == 20) { $q = "pinpgtksem2"; }
				if($_POST["disc_cat_adm"] == 21) { $q = "pinsd34"; }
				if($_POST["disc_cat_adm"] == 22) { $q = "pinsd56"; } 
				if($_POST["disc_cat_adm"] == 23) { $q = "pinsmp8"; }
				if($_POST["disc_cat_adm"] == 24) { $q = "pinsmp9"; }
				if($_POST["disc_cat_adm"] == 25) { $q = "dafultka"; }
				if($_POST["disc_cat_adm"] == 26) { $q = "dafultkb"; }
				
				$periode_enc		= mysqli_real_escape_string($mysql_connect, $periode);
				$level_enc			= mysqli_real_escape_string($mysql_connect, $level);
				$set_cat_adm_enc	= mysqli_real_escape_string($mysql_connect, $q); //actually this last one is no need to be escaped, right? because u have defined it above
				...
				$num_select_disc_adm	= mysqli_num_rows($query_select_disc_adm);
				...
				<?PHP
					while($get_select_disc_adm	= mysqli_fetch_array($query_select_disc_adm, MYSQLI_ASSOC)) {
					...
					$the_lev = (empty($_POST["jenjang"])) ? '' : $_POST["jenjang"];

					echo "<span id=\"text_normal_black\"><i>Data discount administrasi untuk jenjang ".$the_lev." tahun ajaran $periode belum dibuat. Silahkan hubungi Administrator Keuangan</span></i>";
				}
			}
			?>		
			...
			$periode_enc 	= mysqli_real_escape_string($mysql_connect, $_POST["periode"]); 
			$level_enc		= mysqli_real_escape_string($mysql_connect, $jenjang);
			
			//This  synchronization is based on page "page_reg_adm_siswa.php" and the column names on table "set_spp"
			...
			/*
			This pattern is not valid anymore, because we only know 2 kind of payments that will be used in our system
			Those are: umum & anak guru
			...
			*/
			...
			//But, how much money they must pay is depend on the year of student registration.
			
			$ket_disc = substr($periode_enc,-9,2).substr($periode_enc,-2,2);
			...
			$num_row		= mysqli_num_rows($query_get_spp); 
			...
			if($num_row != 0 ) {
				...
				if($_POST["kat_status_anak"] == "umum") {	
					...
					$dibayarkan			= "Status <b>anak umum</b> dikenakan biaya seratus persen (100%) dari ketentuan biaya SPP yang berlaku";	
					//$status_anak		= "Status";	
					
					$cat_disc_spp_error = "tak_ok";
					
				} else if ($_POST["kat_status_anak"] == "anak guru") {
					...
					$dibayarkan			= "Status <b>anak guru</b> dikenakan biaya lima puluh persen (50%) dari ketentuan biaya SPP yang berlaku";
					
					$cat_disc_spp_error = "tak_ok";
					
				} else if ($_POST["kat_status_anak"] == "khusus") {
				
					$non_spp		= $nominal_ict+$nominal_ler+$nominal_kts;
					$src_spp_khusus	= $_POST["value_khusus"];
					
					$cat_disc_spp		= $src_spp_khusus-$non_spp;
					$cat_disc_ict		= $nominal_ict;
					$cat_disc_ler		= $nominal_ler;
					$cat_disc_kts		= $nominal_kts;	
					
					//Bu Fitri told that special SPP payment, will be taken from SPP. So it value may not be smaller than SPP value
					if($cat_disc_spp < 0) {
					
						$cat_disc_spp_error 	= "ok";
						$src_spp_khusus_error	= "Rp " . number_format($src_spp_khusus,0,",",".").",-";
						$non_spp_error			= "Rp " . number_format($non_spp,0,",",".").",-";
						$dibayarkan_error	= "<span style=\"color:#FF0000; font-family:verdana; font-size:16px;\">Proses pendaftaran tidak dapat dilanjutkan, jumlah total biaya SPP khusus (<b>$src_spp_khusus_error</b>) lebih kecil dari jumlah variable pembayaran normal ICT, E-learning dan KS (<b>$non_spp_error</b>). Terjadi angka minus!
												Silakan <a href=\"mainpage.php?pl=reg_adm_siswa_ask\">ulangi kembali</a> pendaftaran, dengan memasukan nominal yang diizinkan untuk biaya SPP khusus</span>";
						$dibayarkan			= "";
						
					} else {
					
						$cat_disc_spp_error = "tak_ok";
						$dibayarkan			= "Status <b>khusus</b> dikenakan biaya khusus ";
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="20">
                    <td colspan="4" align="left" id="text_normal_black"><?= $dibayarkan; ?></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
                <tr height="20">
                    ...
                    <td align="left" id="text_normal_black"><input type="text" name="spp" size="35"  value="<?PHP $cur_total_spp = $cat_disc_spp; echo $cat_disc_spp; ?>" readonly="readonly" /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr> 
                <?PHP
				if($jenjang	== "TK A" || $jenjang	== "TK B" || $jenjang	== "SD" || $jenjang	== "SMP") {
			
				?>               
                <tr height="20">
                    <td width="10" bgcolor="#999999"></td>
                    <td width="200" align="left" bgcolor="#999999" id="text_normal_white">ICT</td>
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" name="ict" size="35"  value="<?PHP $cur_total_spp = $cur_total_spp + $cat_disc_ict; echo $cat_disc_ict; ?>" readonly="readonly" /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
				...
				if($jenjang	== "PG" || $jenjang	== "TK A" || $jenjang == "TK B" || $jenjang	== "SD" || $jenjang	== "SMP") {
				?>
                <tr height="20">
                    <td width="10" bgcolor="#999999"></td>
                    <td width="200" align="left" bgcolor="#999999" id="text_normal_white">E-Learning</td>
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" name="ler" size="35"  value="<?PHP $cur_total_spp = $cur_total_spp + $cat_disc_ler; echo $cat_disc_ler; ?>" readonly="readonly" /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
                ...
                <tr height="20">
                    <td width="10" bgcolor="#999999"></td>
                    <td width="200" align="left" bgcolor="#999999" id="text_normal_white"><?= $kspta; ?></td>
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" name="ks" size="35"  value="<?PHP $cur_total_spp = $cur_total_spp + $cat_disc_kts; echo $cat_disc_kts; ?>" readonly="readonly" /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
                <input type="hidden" name="sub_total_spp" value="<?PHP echo $cur_total_spp; ?>" />
                <tr height="20">
                    <td width="10" bgcolor="#999999"></td>
                    <td width="200" align="left" bgcolor="#999999" id="text_normal_white">Sub Total</td>
                    <td width="5" align="center"></td>
                    <td align="left" id="text_normal_black"><input type="text" size="35"  value="Rp. <?PHP echo $cur_total_spp; ?>" readonly="readonly" style="font-weight:bold; color:#ff0000;" /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="20">
                    ...
                    <td align="left" id="text_normal_black">
						<input type="text" name="zakat_mal" size="35" 
							<?PHP 
								if(!empty($_POST["zakat_mal"])) 
								{ 
									//iMa-7 Mei 2019
									//adding '', to make "<br>" dissaper
									echo "value=''".$_POST["zakat_mal"]; 
								}
								?> 
			...
			*/
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
            	...
            	<tr>
                	<td height="20"><input type="submit" value="submit" id="but_submit" name="but_submit" style="width:250px; height:45px; font-size:16px;" onClick="return verification()" /></td>
                </tr>
            </table>
            <?PHP
			} else {
			
				echo $dibayarkan_error;
