...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
		...
		?>
		<img src="photo/<?= $img_user; ?>" width="200">		
        </td>
        <td width="10"></td>
    	<td align="center">        	
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">            	             
                ...
                <tr height="30">                	
                    ...
                    <td width="10"></td>
                    <td align="left" id="text_normal_black"><input type="file" size="35" name="photo_siswa" value="<?PHP echo $row_select_data_siswa["nama_siswa"]; ?>" /></td>
                    <td width="10"></td>
                </tr>
                <tr>
                	<td colspan="5" height="5"></td>
                ...
                <tr height="30">                	
                    ...
                    <td width="10"></td>
                    <td align="left" id="text_normal_black"><input type="text" size="35" name="ttl_tempat" value="<?PHP echo $row_select_data_siswa["ttl_tempat"]; ?>" /></td>
                    <td width="10"></td>
                </tr>
                <tr>
                	<td colspan="5" height="5"></td>
				...
				$defined_date = substr($row_select_data_siswa["ttl"],8,2);
				$defined_month = substr($row_select_data_siswa["ttl"],5,2);
				$defined_year = substr($row_select_data_siswa["ttl"],0,4);
				?>
                <tr height="30">                	
                	<td width="10" bgcolor="#999999"></td>
                    <td width="200" bgcolor="#999999" id="text_normal_white" align="left">Tanggal lahir</td>
                    <td width="10"></td>
                    <td align="left" id="text_normal_black"><?PHP //include("include/cur_date_opt.php"); ?><select name="tanggal_lahir"><?PHP include("include/cur_date_opt.php"); ?></select><select name="bulan_lahir"><?PHP include("include/cur_month_opt.php"); ?></select><select name="tahun_lahir"><?PHP include("include/cur_year_opt.php"); ?></select></td>
                    <td width="10"></td>
                </tr>  
                <tr>
                	<td colspan="5" height="5"></td>
