    	...
    	<td background="../images/border_mp_middle_center.png" valign="top" align="center">
			...
			?>
            	...
            	<tr>
                	<td width='21'><img src="../images/icon_ok.png"/></td>
                    <td width="10"></td>
                	<td colspan="6" height="5" align="left" valign="top" id="text_normal_black"><span style="color:#006699; font-size:16px;">Nominal: <span style="color:#ff9966;"><b><?= "Rp ".number_format($sender_schspt,0,",",".").",-"; ?></b></span></span></td>
                </tr>
                <tr>
                	<td width='21'><img src="../images/icon_ok.png"/></td>
                    <td width="10"></td>
                	<td colspan="6" height="5" align="left" valign="top" id="text_normal_black"><span style="color:#006699; font-size:16px;">Item pembayaran: <b><?= $sender_schspt_item; ?></b></span></td>
                </tr>
                <tr>
                	<td colspan="3" height="30"><hr noshade="noshade" size="1" /></td>
                </tr>
