    ...
    <tr>
    	...
    	<td align="left">
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <?PHP
				$src_kelas		= "select no_sisda,nama_siswa,tingkat,periode,jenjang,kelas from siswa_finance where tingkat = '$tingkat' and periode = '$periode' order by nama_siswa";
                ...
                <tr height="30">                	
					...
					if($kelas_cur != $kelas) {
					?>
                    <input type="checkbox" name="rubah[]" value="<?= $nama_kelas[$i]."-".$get_kelas["no_sisda"]; ?>" /> Rubah ke kelas <?= $kelas; ?> 
                    <?PHP
					}
					?>
                    </td>
