...
if(isset($_SESSION["id"]) && ($_SESSION["privilege"] == "2")) {
	...
	*/
	if(!empty($_POST["no_sisda"]) || !empty($_GET["no"])) {
		...
		$src_check_cur_siswa_finance 	= "select id,tingkat,kat_status_anak from siswa_finance where no_sisda = '$no_sisda_enc' and periode = '$edu_year_siswa'";
		...
		if($num_check_cur_siswa_finance != 0  ) {
			...
			$num_check_cur_tunggakan	= mysqli_num_rows($query_check_cur_tunggakan);
			...
			$num_check_next_siswa_finance	= mysqli_num_rows($query_check_next_siswa_finance);
	...
	if(!empty($_POST["no_sisda"]) || !empty($_GET["no"])) {
		...
		//$no_sisda_enc	= htmlspecialchars($_POST["no_sisda"]);
		$no_sisda_esc	= mysqli_real_escape_string($mysql_connect, $no_sisda_enc);
		
		
		//aktif = '1' berarti masih ada tunggakan
		$src_select_siswa 	= "select * from siswa_finance where no_sisda = '$no_sisda_esc' and aktif ='1' order by id desc";
		$query_select_siswa	= mysqli_query($mysql_connect, $src_select_siswa) or die(mysql_error());
		$num_select_siswa	= mysqli_num_rows($query_select_siswa);
		$row_select_siswa	= mysqli_fetch_array($query_select_siswa, MYSQLI_ASSOC);
		
		if($num_select_siswa > 0) {
		
			$select_siswa		= mysqli_fetch_array($query_select_siswa, MYSQLI_ASSOC);
?>
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#f1f1f1">            	
                ...
                <tr height="20">
					...
					<script>
						...
						function toggleDisplay(e)
						{
							...
							element = document.getElementById(tableX).style;
							 ...
							 if (imageXval=='plus') 
							 {
								document.getElementById(imgX).src='images/minus.png';eval("imageX"+e+"='minus';");document.getElementById(tableLink).title='Hide Table #'+e+'a';
								}
                    ...
                    <div style="display:none;" id="table1">
						...
						$num_tuk_transaksi		= mysqli_num_rows($query_tuk_transaksi);
						...
						$his_ks				= 0;
							...
							while($row_tuk_transaksi = mysqli_fetch_array($query_tuk_transaksi, MYSQLI_ASSOC)) {
                            ...
                            <tr height="20">
                                ...
                                <td bgcolor="#ffffff" valign="top">
                                	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">  
										...
										<?php
											$qinfopmb = "SELECT * FROM `set_cat_adm_bi_ma` WHERE UPPER(jenjang)='".$row_select_siswa["jenjang"]."X' and set_cat_adm='".$row_select_siswa["kat_status_anak"]."' and periode='".$row_select_siswa["periode"]."'";
											$execinfopmb = mysqli_query($mysql_connect, $qinfopmb);
										?>
                                        <tr>
                                        	<td colspan="6" height="10"></td>
                                        </tr>          	
                                        <tr height="20">
                                            ...
                                            <td width="10" align="left">
												<?php
													...
													$peralatan = 0;
													$paket=0;
													while($row = mysqli_fetch_array($execinfopmb, MYSQLI_ASSOC))
													{ 	
														$totalpmb = $totalpmb + $row["nominal"];
														if($row["cat_adm"] == "penga")
														{
															$pengembangan = $row["nominal"];
														}
														if($row["cat_adm"] == "serag")
														{
															$seragam = $row["nominal"];
														}
													}
													echo "<input type='text' readonly='readonly' value=".number_format($totalpmb)." />";
												?>
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td align="left">
												<input type="text" readonly="readonly" value="<?PHP echo "still no idea" ?>" />
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td align="left">
												<input type="text" readonly="readonly" value=<?php echo number_format($pengembangan)?> >
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td align="left">
												<input type="text" readonly="readonly" value=<?php echo number_format($kegiatan)?> >
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td align="left">
												<input type="text" readonly="readonly" value=<?php echo number_format($seragam)?> >
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td align="left">
												<input type="text" readonly="readonly" value=<?php echo number_format($peralatan)?> >
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td align="left">
												<input type="text" readonly="readonly" value=<?php echo number_format($paket)?> >
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td align="left">
												<input type="text" readonly="readonly" value="<?PHP echo number_format($totalpmb); ?>" />
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                ...
                                <td width="10" bgcolor="#666633"></td>
								<?php
									//beside TK, there is no daftar ulang
									//echo $row_select_siswa["jenjang"];
									if (substr($row_select_siswa["jenjang"], 0, 2) == 'TK')
									{
								?>
                                <td bgcolor="#ffffff" valign="top">
                                	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">  
						...
						<?php						
							// echo $row_select_siswa["jenjang"];
							// echo $row_select_siswa["tingkat"];
							// echo $row_select_siswa["periode"];
							$infospp = "select * from set_spp where UPPER(jenjang) like '".$row_select_siswa["jenjang"]."%' and tingkat=".$row_select_siswa["tingkat"]." and periode='".$row_select_siswa["periode"]."'";
							//echo $infospp;
							$execspp = mysqli_query($mysql_connect, $infospp);
							$spp = 0;$ict = 0;$elear = 0;$kts = 0; $totalspp = 0;
							while($row = mysqli_fetch_array($execspp, MYSQLI_ASSOC))
							{
								if($row["item_byr"] == "spp")
								{
									$spp = $row["nominal"];
                                ...
                                <td bgcolor="#ffffff" valign="top">
                                	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">  
                                        ...
                                        <tr height="20">
                                            ...
                                            <td width="5"></td>
                                            <td width="10" align="left">
												<input type="text" readonly="readonly" value="<?PHP echo number_format($spp); ?>" />
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td width="10" align="left">
												<input type="text" readonly="readonly" value="<?PHP echo number_format($ict); ?>" />
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td width="10" align="left">
												<input type="text" readonly="readonly" value="<?PHP echo number_format($elear); ?>" />
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td width="10" align="left">
												<input type="text" readonly="readonly" value="<?PHP echo number_format($kts); ?>" />
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td></td>
                                            <td width="10" align="left">
												<input type="text" readonly="readonly" value="<?PHP echo number_format($totalspp); ?>" />
											</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                    ...
                    <td>
                    	...
                    	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#669999">  
                            ...
                            <tr height="20">
                                ...
                                <option value="">Pilih</option>
                                <?PHP
								while($get_bank = mysqli_fetch_array($query_get_bank, MYSQLI_ASSOC)) {								
                            ...
                            <tr height="20">
                                ...
                                <td bgcolor="" valign="top">
									...
									if($check_pgtka["jenjang"] == "PG" || $check_pgtka["jenjang"] == "TK A") {
										...
										$query_check_pgtka_nextyear	= mysqli_query($mysql_connect, $src_check_pgtka_nextyear) or die();
										$num_check_pgtka_nextyear	= mysqli_num_rows($query_check_pgtka_nextyear);
										
										
										if($num_check_pgtka_nextyear == 0) {
										
											if($check_pgtka["jenjang"] == "PG") { $next_tingkat_daful = "TK A"; $next_daful_spp = "tka"; }
											if($check_pgtka["jenjang"] == "TK A") { $next_tingkat_daful = "TK B"; $next_daful_spp = "tkb"; }
										
											$do_check_daftar_ulang 	= "ok";
											$do_payment_daful		= "no";
									?>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                    	<tr height="30">
											<td colspan="4" id="text_normal_white" align="left">
                                            	<table width="550" border="0" cellpadding="0" cellspacing="0">
                                                	...
                                                	<tr height="60">
                                                        ...
                                                        <td height="40" bgcolor="#990000"><?PHP include_once("include/check_daftar_ulang.php"); ?></td>
                                	...
                                	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
										...
										$query_daftar_ulang_get_periode		= mysqli_query($mysql_connect, $src_check_arrear_daftar_ulang) or die(mysql_error());
										$num_check_arrear_daftar_ulang		= mysqli_num_rows($query_check_arrear_daftar_ulang);
                                            ...
                                            <td colspan="4">                                            
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10" bgcolor="#1c252f" align="left">
                                                        	<table width="250" border="0" cellpadding="0" cellspacing="0" id="text_normal_white">
                                                                ...
                                                                <?PHP
																$nom_daftar_ulang = 0;
																while($row_check_arrear_daftar_ulang = mysqli_fetch_array($query_check_arrear_daftar_ulang, MYSQLI_ASSOC)) {
																?>
                                                                <tr>
                                                                	<td width="5"></td>
                                                    ...
                                                    <tr height="30">
                                                        ...
                                                        <?PHP while($daftar_ulang_get_periode = mysqli_fetch_array($query_daftar_ulang_get_periode, MYSQLI_ASSOC)) {
														?>
                                                        <option value="<?PHP echo $daftar_ulang_get_periode["periode"]; ?>"><?PHP echo $daftar_ulang_get_periode["periode"]; ?></option>
														<?PHP
														}
														?>
                                                        </select>
                                        ...
                                        <tr height="20">
                                            ...
                                            <td colspan="4"> 
												...
												if( 
													...
													//echo "tewewew";
													$do_check_spp_next_year = "ok";
													include("include/check_spp_next_year.php");
                                            	...
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10" bgcolor="#1c252f" align="left">
                                                        	<table width="250" border="0" cellpadding="0" cellspacing="0" id="text_normal_white">
																...
																<?PHP
																$nom_spp = 0;
                                                                while($row_check_arrear_spp = mysqli_fetch_array($query_check_arrear_spp, MYSQLI_ASSOC)) {
                                                                ?>
                                                                <tr>
                                                                	<td width="5"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?PHP
														while($row_check_arrear_spp_auto = mysqli_fetch_array($query_check_arrear_spp_auto, MYSQLI_ASSOC)) {
									...
									if(mysqli_num_rows($query_check_cataj_num_day) == '0') { 
									?>
									...
									$num_check_arrear_catering			= mysqli_num_rows($query_check_arrear_catering);
									...
									$num_check_arrear_antar_jemput			= mysqli_num_rows($query_check_arrear_antar_jemput);
                                            ...
                                            <td colspan="4">
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10" bgcolor="#1c252f" align="left">
                                                        	<table width="250" border="0" cellpadding="0" cellspacing="0" id="text_normal_white">
																...
																$nom_catering = 0;
                                                                while($row_check_arrear_catering = mysqli_fetch_array($query_check_arrear_catering, MYSQLI_ASSOC)) {
                                                                ?>
                                                                <tr>
                                                                	<td width="5"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <option value="---0"></option>
														<?PHP
														while($row_check_arrear_catering_auto = mysqli_fetch_array($query_check_arrear_catering_auto, MYSQLI_ASSOC)) {
                                            	...
                                            	<table bgcolor="#999999" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10" bgcolor="#1c252f" align="left">
                                                        	<table width="250" border="0" cellpadding="0" cellspacing="0" id="text_normal_white">
																...
																$nom_antar_jemput = 0;
                                                                while($row_check_arrear_antar_jemput = mysqli_fetch_array($query_check_arrear_antar_jemput, MYSQLI_ASSOC)) {
                                                                ?>
                                                                <tr>
                                                                	<td width="5"></td>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <option value="---0"></option>
														<?PHP
														while($row_check_arrear_antar_jemput_auto = mysqli_fetch_array($query_check_arrear_antar_jemput_auto, MYSQLI_ASSOC)) {
...
function MakeSum() { 
	...
	*/
	...
	while($get_schspt2	= mysqli_fetch_array($query_get_schspt2, MYSQLI_ASSOC)) {
	?>
