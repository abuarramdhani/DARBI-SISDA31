...
if(isset($_SESSION["id"]) && ($_SESSION["privilege"] == "2")) {
	...
	if($chk_no_sisda != "" || $chk_sekolah_asl != "") { 
		...
		if($chk_no_sisda != "") {
			...
			$num_chk_no_sisda_exist		= mysqli_num_rows($query_chk_no_sisda_exist);
			
			if($num_chk_no_sisda_exist != 0) {
			
				$no_sisda_not_found = "ketemu";
				
				$get_chk_no_sisda_exist	= mysqli_fetch_array($query_chk_no_sisda_exist, MYSQLI_ASSOC);
    ...
    <tr>
    	...
    	<td>
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				?>
                <input type="hidden" name="no_sisda" value="<?= $chk_no_sisda; ?>" />
                <tr height="20">
                	<td width="10" bgcolor="#999999"></td>
                    <td width="200" bgcolor="#999999" id="text_normal_white">Nama Lengkap</td>
                    <td width="5"></td>
                ...
                <tr height="20">
                    ...
                    <select name="kat_status_anak" onchange="toggleSelect()">
                    ...
                    <br />
                    <input type="text" name="value_khusus" size="35" placeholder="Nominal SPP khusus" /></td>
                </tr>
                <tr>
                	<td colspan="4" height="5"></td>
                </tr>
...
function happycode(){
	...
	document.reg_adm_siswa.value_khusus.disabled = true;
}
...
function toggleSelect() {
	...
	if (document.reg_adm_siswa.kat_status_anak.value == "khusus") {
	
		document.reg_adm_siswa.value_khusus.disabled = false;
...
{ 
	...
	if(document.reg_adm_siswa.kat_status_anak.value == "")
	{
