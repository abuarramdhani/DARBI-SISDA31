...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="25">
    	<td width="30"></td>
        <td id="text_title_page1" align="center">Edit Nominal Antar Jemput (Special case)</td>
        <td width="30"></td>
    </tr>
    <tr>
    	<td></td>
    ...
    <tr>
    	...
    	<td align="center">
			...
			?>
            <form name="search" method="post" action="?pl=edit_nominal_special_case_antar_jemput">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
            	...
            	<tr height="20">
					...
					*/
					?>
                    <form method="post" action="?pl=edit_nominal_special_case_antar_jemput">
        	...
        	<form method="post" name="reg_adm_siswa" action="?pl=edit_nominal_special_case_antar_jemput_do">
            	<input type="hidden" name="no_sisda" value="<?= $srch_no_sisda; ?>" />
                <input type="hidden" name="nama_siswa" value="<?= $srch_nama_siswa; ?>" />
                <input type="hidden" name="jenjang" value="<?= $srch_jenjang; ?>" />
                <input type="hidden" name="tingkat" value="<?= $srch_tingkat; ?>" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
            	<tr height="20">
                    <td width="50"><span id="text_normal_black">Halaman: </span><td>
                    <td align="left"> 
                    <form method="post" action="mainpage.php?pl=edit_nominal_special_case_antar_jemput">
                    <input type="hidden" name="no_sisda" value="<?= $srch_no_sisda; ?>" />
                    <input type="hidden" name="nama_siswa" value="<?= $srch_nama_siswa; ?>" />
                    <input type="hidden" name="jenjang" value="<?= $srch_jenjang; ?>" />
                    <input type="hidden" name="tingkat" value="<?= $srch_tingkat; ?>" />
