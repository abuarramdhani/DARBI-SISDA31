                            ...
                            <tr height="20">
                                ...
                                <td bgcolor="" valign="top">
                                	...
                                	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                                        ...
                                        <tr>
                                        	<td width="10" ></td>
                                        	<td colspan="4" height="10"><input type="button" value="Data Keuangan" onclick="javascript:void window.open('popup.php?pl=chk_no_sisda','','width=700,height=500,toolbar=0,location=0,status=0,scrollbars=0,resizable=0,left=0,top=0'); return false;" /><input type="button" value="History Pembayaran Daftar Ulang" /></td>
                                            <td width="10" ></td>
                                        </tr>
                                        <tr>
                                        	<td colspan="6" height="10"></td>
