...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="25">
    	<td width="30"></td>
        <td id="text_title_page1" align="center">Rekapitulasi Rumah Berbagi</td>
        <td width="30"></td>
    </tr>
    <tr>
    	<td></td>
    ...
    <tr>
    	...
    	<td align="center">
			...
			$src_get_siswa		= "select 
									...
									jenis_transaksi = 'rumah_berbagi' and									
            ...
            <form name="search" method="post" action="?pl=rekap_catering">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
            	...
            	<tr height="20">
					...
					*/
					?>
                    <form method="post" action="mainpage.php?pl=rekap_catering">
        	...
        	<table width="100%" border="0" cellpadding="5" cellspacing="1" style="border: 1px blue dotted;">  
            	<tr height="30">  
                    ...
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Zakat mal</td>
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Zakat profesi</td>
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Infaq</td>
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Wakaf</td>
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Zakat fitrah</td>
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Fidyah</td>
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Baksos Ramadhan</td>
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Qurban</td>
                </tr>
                <?PHP
                ...
                <tr height="30">                
                    ...
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["zakat_mal_ruba"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["zakat_mal_ruba"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["zakat_profesi_ruba"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["zakat_profesi_ruba"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["infaq_sho_ruba"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["infaq_sho_ruba"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["wakaf_ruba"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["wakaf_ruba"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["zakat_fitrah_ruba"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["zakat_fitrah_ruba"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["fidyah_ruba"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["fidyah_ruba"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["baksos_ramadhan_ruba"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["baksos_ramadhan_ruba"],0,",",".").",-"; } ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP if($get_siswa["qurban_ruba"] == 0) { echo "0"; } else { echo "Rp".number_format($get_siswa["qurban_ruba"],0,",",".").",-"; } ?></td>
                </tr>
                <?PHP
					if($bg	== "#ffffff") {
						$bg	= "#f1f1f1";
