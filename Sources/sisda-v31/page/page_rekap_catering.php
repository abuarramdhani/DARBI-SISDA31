...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="25">
    	<td width="30"></td>
        <td id="text_title_page1" align="center">Rekapitulasi Catering</td>
        <td width="30"></td>
    </tr>
    <tr>
    	<td></td>
    	...
    	<td align="center">
        	...
        	<table width="100%" border="0" cellpadding="5" cellspacing="1" style="border: 1px blue dotted;">  
            	<tr height="30">  
                    ...
                    <td width="" bgcolor="#999999" id="text_normal_white" align="center">Jumlah Bulan Catering</td>
                ...
                <tr height="30">                
                    ...
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP echo $get_siswa["jumlah_bulan_catering"]; ?></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center"><?PHP echo $get_siswa["bulan_catering"]; ?></td>
