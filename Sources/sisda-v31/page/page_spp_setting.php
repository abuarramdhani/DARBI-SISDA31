...
?>
            ...
            <td>
                <table width="100%" border="1" cellpadding="0" cellspacing="0" id="text_normal_white" style="text-align:center;">
                    <tr height="25" bgcolor="#333333">
                        <td colspan="6">Tahun pelajaran: <?PHP include"include/period_refr_page.php"; ?><input type="hidden" name="src_periode" value="<?PHP echo substr($_GET["periode"],-11,11); ?>" /></td>
                    </tr>
                    <?PHP
					...
					//Coba nt peratiin kamal... dia klo lagi coding mentog.... pasti nyanyi dududududu...hehehehe...
                    ...
                    <?PHP
						...
						$src_j_enc	= mysqli_real_escape_string($mysql_connect, $src_j);
						$periode_enc	= mysqli_real_escape_string($mysql_connect, $_GET["periode"]);
						...
						$num_check_periode	= mysqli_num_rows($query_check_periode);
						
						if($num_check_periode != 0) {
						?>
                        <tr height="150">
                    		<td colspan="6" align="center" id="text_normal_black"><b>Nilai nominal SPP untuk Jenjang <?PHP echo  $title_page; ?> tahun pelajaran <?PHP echo $periode_enc; ?>, sudah dilakukan.<br /> Untuk merubahnya silahkan lakukan proses editing pada daftar nominal SPP yang ada di bawah form ini.</b></td>
                    	</tr>
                        <?PHP
						} else {
						?>
                            ...
                            */
                            ...
                            <tr height="25" bgcolor="#83736c">
                                ...
                                <td><input type="text" size="10" name="1-per1-kts" onkeypress="return checkIt(event)"/></td>
                                <td><input type="text" size="10" name="1-per1-ler" onkeypress="return checkIt(event)"/></td>
                            </tr>                                              
							<?PHP
                            if($src_j == "smp" || $src_j == "sd") {
                                ...
                                <tr height="25" bgcolor="#8a6c66">
                                    ...
                                    <td><input type="text" size="10" name="2-per1-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="2-per1-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                ...
                                <tr height="25" bgcolor="#8a6c66">
                                    ...
                                    <td><input type="text" size="10" name="2-per2-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="2-per2-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>                                
                                <?PHP
                                ...
                                <tr height="25" bgcolor="#8d6774">
                                    ...
                                    <td><input type="text" size="10" name="3-per1-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="3-per1-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-1) < 10) {
                                ...
                                <tr height="25" bgcolor="#8d6774">
                                    ...
                                    <td><input type="text" size="10" name="3-per2-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="3-per2-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                ...
                                <tr height="25" bgcolor="#8d6774">
                                    ...
                                    <td><input type="text" size="10" name="3-per3-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="3-per3-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>                                
							<?PHP
                            }
                            ...
                            if($src_j == "sd") {
                                ...
                                <tr height="25" bgcolor="#7f7085">
                                    ...
                                    <td><input type="text" size="10" name="4-per1-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="4-per1-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-2) < 10) {
                                ...
                                <tr height="25" bgcolor="#7f7085">
                                    ...
                                    <td><input type="text" size="10" name="4-per2-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="4-per2-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-1) < 10) {
                                ...
                                <tr height="25" bgcolor="#7f7085">
                                    ...
                                    <td><input type="text" size="10" name="4-per3-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="4-per3-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                ...
                                <tr height="25" bgcolor="#7f7085">
                                    ...
                                    <td><input type="text" size="10" name="4-per4-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="4-per4-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                ...
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><input type="text" size="10" name="5-per1-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="5-per1-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-3) < 10) {
                                ...
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><input type="text" size="10" name="5-per2-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="5-per2-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-2) < 10) {
                                ...
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><input type="text" size="10" name="5-per3-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="5-per3-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-1) < 10) {
                                ...
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><input type="text" size="10" name="5-per4-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="5-per4-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                ...
                                <tr height="25" bgcolor="#58778a">
                                    ...
                                    <td><input type="text" size="10" name="5-per5-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="5-per5-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                ...
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><input type="text" size="10" name="6-per1-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="6-per1-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-4) < 10) {
                                ...
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><input type="text" size="10" name="6-per2-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="6-per2-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-3) < 10) {
                                ...
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><input type="text" size="10" name="6-per3-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="6-per3-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-2) < 10) {
                                ...
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><input type="text" size="10" name="6-per4-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="6-per4-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                if((substr($_GET["periode"],-9,2)-1) < 10) {
                                ...
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><input type="text" size="10" name="6-per5-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="6-per5-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>
                                <?PHP
                                ...
                                <tr height="25" bgcolor="#668285">
                                    ...
                                    <td><input type="text" size="10" name="6-per6-kts" onkeypress="return checkIt(event)"/></td>
                                    <td><input type="text" size="10" name="6-per6-ler" onkeypress="return checkIt(event)"/></td>
                                </tr>                               
                        ...
                        ?>
                                <tr height="60" bgcolor="#333333">
                                    <td colspan="6" align="center"><input style="background:#006699; color:#FFFFFF; width:200px; height:45px;" type="submit" value="Simpan nilai SPP" onClick="return verification()"/> <input type="reset" value="Reset" /></td>
                                </tr>
                    <?PHP
                    	}						
                	}
	...
	$src_j	= mysqli_real_escape_string($mysql_connect, $src_j);
    ...
    $num_load_spp_all		= mysqli_num_rows($query_load_spp_all);
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td align="left">
                ...
                $no	= $the_limit + 1;
                while($row_load_spp = mysqli_fetch_array($query_load_spp, MYSQLI_ASSOC)) {			
                ?>
