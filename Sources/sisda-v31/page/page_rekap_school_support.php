    ...
    <tr>
    	...
    	<td align="center">
			...
			$src_get_siswa		= "
									...
									jenis_transaksi = 'school_support' and									
        	...
        	<table width="100%" border="0" cellpadding="4" cellspacing="1" style="border: 1px blue dotted; font-size:10px;">  
            	<tr height="30">  
                    ...
                    <td width="" bgcolor="#999999" id="cetak_rekap_putih" align="center">Item</td>
				...
				if($num_get_siswa_all != 0) {
					...
					while($get_siswa = mysql_fetch_array($query_get_siswa)) {
						...
						$nom_school_support = $get_siswa["school_support"];
					...
					<tr height="30">                
						...
						<td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP echo $get_siswa["item_school_support"]; ?></td>
                        <td width="" bgcolor="<?PHP echo $bg; ?>" id="cetak_rekap_hitam" align="center"><?PHP if($nom_school_support == 0) { echo $nom_school_support; } else { echo "Rp ".number_format($nom_school_support,0,",",".").",-"; } ?></td>
                        
					</tr>
					<?PHP
						$total_nom_school_support_trs	= $total_nom_school_support_trs + $nom_school_support;
					...
					?>
					<tr height="30">                
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="left" colspan="9"><b>Jumlah total:</b></td>
						<td width="" bgcolor="#333333" id="cetak_rekap_putih" align="center"><?PHP if($total_nom_school_support_trs == 0) { echo "0"; } else { echo "Rp ".number_format($total_nom_school_support_trs,0,",",".").",-"; } ?></td>
					</tr>
                 <?PHP
				 }
				 ?>
