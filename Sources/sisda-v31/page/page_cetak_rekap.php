...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="25">
    	<td width="30"></td>
        <td id="text_title_page1" align="center">Cetak Rekapitulasi Transaksi</td>
        <td width="30"></td>
    </tr>
    <tr>
    	<td></td>
    ...
    <tr>
    	...
    	<td align="center">
			...
			?>
            <form name="search" method="post" action="?pl=cetak_rekap">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
            	<tr height="20">
                    ...
                    <td align="right">
                    <form method="post" name="cetak_rekap_semua" action="page/page_cetak_rekap_semua.php">
