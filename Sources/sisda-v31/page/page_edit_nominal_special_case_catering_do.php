...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="25">
    	<td width="30"></td>
        <td id="text_title_page1" align="center">Edit Nominal Catering<br /></td>
        <td width="30"></td>
    </tr>
    <tr>
    	<td></td>
    	...
    	<td align="center">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" >
				...
				function read_only($prevval_cataj) {
					...
					else if ($pref2 == 1) { if($value2 == "x") { echo "style='background-color:#3399ff; color:#ffffff; text-align:center; border:0px;' readonly='readonly' title='Jumlah hari catering belum didefiniskan (tidak dapat diedit)'"; } else { echo "style='text-align:center;'"; }  }
				...
				function provider($prov,$prov_val) {
					...
					else if($pref_prov == 1) { if($val_for_prov == 'x') { echo "style='background-color:#0099cc; color:#ffffff; text-align:center; border:0px;' readonly='readonly' value='' title='Jumlah hari catering belum ditentukan (tidak dapat diedit)'"; } else { echo "style='text-align:center;' value='".$prov_val."'"; } }
                ...
                <tr>
                	<td height="30"><input type="hidden" name="jenis_tunggakan" value="catering" /></td>
                </tr>
                <tr>
                	<td align="center" colspan="12"><input type="submit" value="Edit data tunggakan Catering" style="width:250px; height:50px; background-color:#663333; color:#FFFFFF;" /></td>
                </tr>
                </form>
            </table>
		</td>
