<table border="1" cellpadding="0" cellspacing="0" id="text_normal_white" style="text-align:center;">                
    ...
    */
    ...
    <tr height="25" bgcolor="#333333" id="text_normal_white">
        ...
        <td width="250"><span style="color:#FF0000;">Kegiatan</span></td>
        <td width="250">Peralatan</td>
        <td width="250"><span style="color:#FF0000;">Seragam</span></td>
        <td width="250">Paket</td>
        <td width="250">Pengembangan</td>
        <td width="250"><span style="color:#FF0000;">Kegiatan</span></td>
        <td width="250">Peralatan</td>
    ...
    <tr height="45" bgcolor="#8a6c66" id="text_normal_white">
        ...
        <td><input type="text" name="tka_kegia_dafultka" size="8" onkeypress="return checkIt(event)" style="background-color:#FF0000; color:#FFFFFF;" placeholder="daftar ulang"/></td>
        <td><input type="text" name="tka_peral_dafultka" size="8" readonly="readonly" style="background-color:#999999;" /></td>
        <td><input type="text" name="tka_serag_dafultka" size="8" onkeypress="return checkIt(event)" style="background-color:#FF0000; color:#FFFFFF;" placeholder="daftar ulang" /></td>
    ...
    <tr height="45" bgcolor="#8a6c66" id="text_normal_white">
        ...
        <td><input type="text" name="tkb_kegia_dafultkb" size="8" onkeypress="return checkIt(event)" style="background-color:#FF0000; color:#FFFFFF;" placeholder="daftar ulang"/></td>
