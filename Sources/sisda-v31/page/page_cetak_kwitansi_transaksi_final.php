...
//echo "spp: ".$sender_spp."<br>";
//echo "spp_suc: ".$sender_spp_succeed."<br>";
?>
    	...
    	<td>
            ...
            <table width="512" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="20">
                    ...
                    <td id="text_normal_black">:</td>
                    <td id="text_normal_black">Rp <?= number_format($sender_daful,0,",",".").",-"; ?></td>
                </tr>
                <?PHP
                ...
                <tr height="20">
                    ...
                    <td id="text_normal_black">:</td>
                    <td id="text_normal_black"><?= $sender_cetak_nom_item_schspt." [ket: ".$sender_ket_schspt_enc."]"; ?></td>
                </tr>
...
<table width="1045" border="0" cellpadding="0" cellspacing="0">
	<tr height="20">
    	<td><input type="button" value="." onclick="window.location.href='<?= $darbi_url; ?>mainpage.php';" style="background-color:#FFFFFF;"  /></td>
    </tr>
</table>
</body>
</html>