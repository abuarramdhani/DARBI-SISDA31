...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
    	...
    	<td align="left">
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
            	<tr>
                    <td colspan="17" align="center" bgcolor="#666666" height="50"><input type="submit" value="Tambah siswa untuk kelas <?= $kelas; ?>" style="height:40px; width:400px; background-color:#339966; color:#FFFFFF; font-size:14px;" /> <a href="#" onMouseOver="stm(Text[5],Style[12])" onMouseOut="htm()"><img src="images/what_happen_aya_naon.jpg" border="0" /></a></td>
                </tr>     
            	<tr height="30">                	
                ...
                <?PHP
				$src_kelas		= "select no_sisda,nama_siswa,tingkat,periode,jenjang,kelas from siswa_finance where kelas = '$kelas' and periode = '$periode'"; //echo $src_kelas;
				$query_kelas 	= mysqli_query($mysql_connect, $src_kelas) or die(mysql_error());
				$um_kelas 		= mysql_num_rows($query_kelas);
                ...
                <tr height="30">                	
                    ...
                    <td width="10" bgcolor="<?PHP echo $bg; ?>"></td>
                    <td width="" bgcolor="<?PHP echo $bg; ?>" id="text_normal_black" align="center" style="color:<?= $kelas_col; ?>"><?= $kelas; ?></td>
                    <td width="10" bgcolor="<?PHP echo $bg; ?>"></td>
                </tr>	
                <?PHP
					if($bg	== "#ffffff") {
