                            ...
                            <tr height="20">
                                ...
                                <td bgcolor="" valign="top">
                                	...
                                	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                                        ...
                                        <?PHP
										//check whether reregistration process has been done?
										//fisrtly we need to know current ecu year
										
										$cur_month_daful	= strtolower(date("F"));
										$cur_year_daful	= date("Y");
										...
										if($cur_month_daful == "january" || $cur_month_daful == "february" || $cur_month_daful == "march" || $cur_month_daful == "april" || $cur_month_daful == "may" || $cur_month_daful == "june") {	
											
											$edu_year_next_daful 		= ($cur_year_daful)." - ".($cur_year_daful+1); //$edu_year1	= ($cur_year_daful-1)." - ".($cur_year_daful);	
											$edu_year_next_daful_cur	= ($cur_year_daful-1)." - ".($cur_year_daful);
										
										} else if ($cur_month_daful == "july" || $cur_month_daful == "august" || $cur_month_daful == "september" || $cur_month_daful == "october" || $cur_month_daful == "november" || $cur_month_daful == "december") {	
											
											$edu_year_next_daful 		= ($cur_year_daful+1)." - ".($cur_year_daful+2); //$edu_year1	= ($cur_year_daful)." - ".($cur_year_daful+1);	
											$edu_year_next_daful_cur 	= ($cur_year_daful)." - ".($cur_year_daful+1);
										
										}
										
										
										$src_check_tingkat_daful 	= "select jenjang from siswa_finance where no_sisda = '$no_sisda_enc' and periode = '$edu_year_next_daful_cur'";
										$query_check_tingkat_daful	= mysqli_query($mysql_connect, $src_check_tingkat_daful) or die(mysql_error());
										$row_check_tingkat_daful	= mysql_fetch_array($query_check_tingkat_daful);
										$check_tingkat_daful		= $row_check_tingkat_daful["jenjang"];
										//echo "edu_year_next_daful = ".$edu_year_next_daful."<br>";
										
										
										if($check_tingkat_daful == "PG" || $check_tingkat_daful == "TK A") {
										
											if($check_tingkat_daful == "PG") { $gat_to_set_spp_daful = "pl=spp_setting&j=tkb"; $stat_next_jenjang_daful = "TK B"; }
											if($check_tingkat_daful == "TK A") { $gat_to_set_spp_daful = "pl=spp_setting&j=sd";  $stat_next_jenjang_daful = "SD"; }
											
											
											$src_check_exist_daful 		= "select id from siswa_finance where no_sisda = '$no_sisda_enc' and periode = '$edu_year_next_daful'";
											$query_check_exist_daful	= mysqli_query($mysql_connect, $src_check_exist_daful) or die(mysql_error());
											$num_check_exist_daful		= mysql_num_rows($query_check_exist_daful);
											
											//echo "src_check_exist_daful = ".$src_check_exist_daful ."<br>";
											//echo "num_check_exist_daful = ".$num_check_exist_daful."<br>";
											
											
											if($num_check_exist_daful == 0) {
											
												$src_check_adm_daful_next_year	= 
																					"
																						select id, nominal from set_cat_adm_bi_ma 
																						where 
																						(periode = '$edu_year_next_daful' and jenjang = 'tka' and cat_adm = 'kegia' and set_cat_adm = 'dafultka') or
																						(periode = '$edu_year_next_daful' and jenjang = 'tka' and cat_adm = 'peral' and set_cat_adm = 'dafultka') or
																						(periode = '$edu_year_next_daful' and jenjang = 'tka' and cat_adm = 'serag' and set_cat_adm = 'dafultka') or
																						(periode = '$edu_year_next_daful' and jenjang = 'tkb' and cat_adm = 'kegia' and set_cat_adm = 'dafultkb') or
																						(periode = '$edu_year_next_daful' and jenjang = 'tkb' and cat_adm = 'peral' and set_cat_adm = 'dafultkb') or
																						(periode = '$edu_year_next_daful' and jenjang = 'tkb' and cat_adm = 'serag' and set_cat_adm = 'dafultkb')
																					";
												$query_check_adm_daful_next_year = mysqli_query($mysql_connect, $src_check_adm_daful_next_year) or die(mysql_error());
												$num_check_adm_daful_next_year	= mysql_num_rows($query_check_adm_daful_next_year);
												
												$inc_nom_adm_daful_chk	= "";
												
												while($check_adm_daful_next_year = mysql_fetch_array($query_check_adm_daful_next_year)) {
												
													$nominal_cur_adm_daful	= $check_adm_daful_next_year["nominal"];
													
													if($nominal_cur_adm_daful != 0) {
													
														$inc_nom_adm_daful_chk = $inc_nom_adm_daful_chk + 1;
													
													}
												
												} 
												
												if($inc_nom_adm_daful_chk == 6) {
												
													$src_check_spp_daful_next_year =
																					"
																						select id, nominal from set_spp
																						where
																						(periode = '$edu_year_next_daful' and tingkat = 'tka' and item_byr = 'spp') or
																						(periode = '$edu_year_next_daful' and tingkat = 'tka' and item_byr = 'ict') or
																						(periode = '$edu_year_next_daful' and tingkat = 'tka' and item_byr = 'ler') or
																						(periode = '$edu_year_next_daful' and tingkat = 'tkb' and item_byr = 'spp') or
																						(periode = '$edu_year_next_daful' and tingkat = 'tkb' and item_byr = 'ict') or
																						(periode = '$edu_year_next_daful' and tingkat = 'tkb' and item_byr = 'ler')
																					";	
													...
													$inc_nom_spp_daful_chk	= "";	
													
													while($check_spp_daful_next_year = mysql_fetch_array($query_check_spp_daful_next_year)) {
													
														$nominal_cur_spp_daful	= $check_spp_daful_next_year["nominal"];
													
														if($nominal_cur_spp_daful != 0) {
														
															$inc_nom_spp_daful_chk = $inc_nom_spp_daful_chk + 1;
														
														}
													
													}	
													
													if($inc_nom_spp_daful_chk == 6) {
													
														$fail_daful = "no"; //ini artinya bisa boss, untuk daftar ulang
													
													} else {
													
														$fail_daful 		= "yes";
														$fail_daful_message	= "Setting SPP untuk ajaran $edu_year_next_daful belum dilakukan/lengkap";
														$fail_type_daful	= "spp";
													...
													$fail_daful 		= "yes";
													$fail_daful_message	= "Setting biaya daftar ulang untuk ajaran $edu_year_next_daful belum dilakukan/lengkap";
													$fail_type_daful	= "biaya_daful";
												...
												$fail_daful 		= "yes";
												$fail_daful_message	= "Daftar ulang untuk tahun ajaran $edu_year_next_daful sudah dilakukan";
												$fail_type_daful	= "sudah";
											
											}
											
											//echo "num_check_adm_daful_next_year = ".$num_check_adm_daful_next_year."<br>";
											//echo "num_check_spp_daful_next_year = ".$num_check_spp_daful_next_year."<br>";
											//echo "inc_nom_spp_daful_chk = ".$inc_nom_spp_daful_chk."<br>";
											//echo "inc_nom_adm_daful_chk = ".$inc_nom_adm_daful_chk."<br>";
											//echo "fail_daful = ".$fail_daful."<br>";
											//echo "fail_daful_message = ".$fail_daful_message."<br>";
											if($fail_daful == "yes") {
											?>
											<tr>
												<td></td>
												<td colspan="4" height="10" id="text_normal_black"><?PHP echo $fail_daful_message;?></td>
												<td></td>
											</tr>
                                            <tr>
												<td></td>
												<td colspan="4" height="10" id="text_normal_black">&nbsp;</td>
												<td></td>
											</tr>
											<tr>
												<td></td>
												...
												<?PHP
												if($fail_type_daful == "biaya_daful") {
												?>
												<input type="button" value="&nbsp;&nbsp;&nbsp;Setting Biaya Daftar Ulang <?= $edu_year_next_daful; ?>&nbsp;&nbsp;&nbsp;" onclick="window.location.href='?pl=cat_adm_bi_ma_setting_frame';" style="height:40px; background-color:#993366; color:#FFFFFF; font-size:14px;" />
												<?PHP
												}
												?>
												<?PHP
												if($fail_type_daful == "spp") {
												?>
												<input type="button" value="&nbsp;&nbsp;&nbsp;Setting Biaya SPP <?= $stat_next_jenjang_daful; ?> <?= $edu_year_next_daful; ?>&nbsp;&nbsp;&nbsp;" onclick="window.location.href='?<?= $gat_to_set_spp_daful; ?>';" style="height:40px; background-color:#993366; color:#FFFFFF; font-size:14px;" />
												<?PHP
												}
												?>
												</td>
											...
											<tr>
												...
												<td colspan="4" height="10">
												<?PHP
												$src_token_daful	= md5($no_sisda_enc.$edu_year_next_daful_cur.$darbi_key);
												$token_daful 		= substr($src_token_daful,0,15);
												?>
												<input type="button" value="&nbsp;&nbsp;&nbsp;Setting Data Daftar Ulang ( <?= $row_select_siswa["nama_siswa"]; ?> / <?= $edu_year_next_daful; ?> )&nbsp;&nbsp;&nbsp;" onclick="window.location.href='?pl=request_setting_daful&no=<?= $no_sisda_enc; ?>&p=<?= $edu_year_next_daful; ?>&token=<?= $token_daful; ?>';" style="height:40px; background-color:#993366; color:#FFFFFF; font-size:14px;" />
												</td>
												<td></td>
											</tr>
											<?PHP
                                        ...
                                        <tr>
                                        	<td></td>
                                            <td colspan="4" height="10">daftar ulang hanya dapat dilakukan oleh siswa PG dan TK A</td>
                                            <td></td>
                                        </tr>
										<?PHP
										}
                                   ...
                                   <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">  
                                	...
                                	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff"> 
                                        ...
                                        <tr height="20">
                                            <td width="10"></td>
                                            <td width="10" bgcolor="#999999"></td>
                                            <td width="200" bgcolor="#999999" id="text_normal_white">Keterangan</td>
                                            <td width="5"></td>
                                            <td align="left"><textarea name="ket_schspt" rows="3"></textarea></td>
                                            <td>&nbsp;</td>
                                        </tr> 
                                        <tr>
                                            <td colspan="6" height="5"></td>
