    ...
    <tr>
    	...
    	<td align="center">
            ...
            <table width="1000" border="0" cellpadding="0" cellspacing="0">  
                ...
                <tr bgcolor="#006699" id="text_normal_white" height="25">
                	<td></td>
                    <td align="right">Komponen pembayaran Daftar Ulang</td>
                    <td></td>
                    <td>
                    <select name="daful_tka">
                    <option value="">daftar ulang TK A</option>
                    <?PHP
                    ...
                    <br />
                    <select name="daful_tkb">
                    <option value="">daftar ulang TK B</option>
                    <?PHP
					for($i_persen = 1; $i_persen <= 100; $i_persen++) {
					?>
					<option value="<?= $i_persen; ?>"><?= $i_persen; ?> %</option>
                    ...
                    <td></td>
                    <td align="right" id="text_normal_white">Komponen pembayaran SPP SD</td>
                    <td></td>
                    <td>
                    <select name="spp_sd">
                ...
                <tr bgcolor="#006699">
                	<td></td>
                    <td align="right" id="text_normal_white">Komponen pembayaran SPP TK</td>
                    <td></td>
                    <td>
                    <select name="spp_tk">
                    <option value="">SPP</option>
                    ...
                    <td></td>
                    <td align="right" id="text_normal_white">Komponen pembayaran SPP SMP</td>
                    <td></td>
                    <td>
                     <select name="spp_smp">
                    <option value="">SPP</option>
        	...
        	<table width="1000" border="0" cellpadding="0" cellspacing="0">            	             
            	...
            	<tr height="30" align="center">                	
                    ...
                    <td width="10" bgcolor="#999999"></td>
                    <td width="150" bgcolor="#999999" id="text_normal_white">Periode</td>
                    <td width="10" bgcolor="#999999"></td>
                    <td width="80" bgcolor="#999999" id="text_normal_white">Daftar ulang <br />TK A</td>
                    <td width="10" bgcolor="#999999"></td>
                    <td width="80" bgcolor="#999999" id="text_normal_white">Daftar ulang <br />TK B</td>
                    <td width="10" bgcolor="#999999"></td>
                ...
                <tr height="30" align="center">                	
                    ...
                    <td bgcolor="<?PHP echo $bg; ?>"></td>
                    <td bgcolor="<?PHP echo $bg; ?>" id="text_normal_black"><?= $get_persen["daful_tka"]; ?>%</td>
                    <td bgcolor="<?PHP echo $bg; ?>"></td>
                    <td bgcolor="<?PHP echo $bg; ?>" id="text_normal_black"><?= $get_persen["daful_tkb"]; ?>%</td>
                    <td bgcolor="<?PHP echo $bg; ?>"></td>
...
function verification() { 
	...
	if(document.persen_bayar.daful_tka.value == "") {
		alert('Nilai persen anak guru untuk daftar ulang TK A harus diisi');
		return false;
	}
	if(document.persen_bayar.daful_tkb.value == "") {
		alert('Nilai persen anak guru untuk daftar ulang TK B harus diisi');
		return false;
	}
