...
?>
	 <table width="100%" border="0" cellpadding="0" cellspacing="1">
     	<tr>
            <td id="text_normal_black" colspan="2"><h1>History Pembayaran Daftar Ulang</h1></td>
        </tr>
        <tr>
        	<td></td>
...
<?PHP
	$bg = "#dfe5e6"; 
    $src_get_data 	= "select * from transaksi where no_sisda = '$no_sisda' and (kegiatan_daful != '0' or peralatan_daful  != '0' or seragam_daful != '0')";
...
?>
        <tr bgcolor="<?= $bg; ?>" id="text_normal_black" height="25">
            ...
            <td align="center"><?= $get_data["kegiatan_daful"]; ?></td>
            <td align="center"><?= $get_data["peralatan_daful"]; ?></td>
            <td align="center"><?= $get_data["seragam_daful"]; ?></td>
        </tr>
<?PHP
			if($bg == "#dfe5e6") {
				$bg = "#d7d3c8";
