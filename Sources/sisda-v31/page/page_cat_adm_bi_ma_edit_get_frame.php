<table width="100%" border="1" cellpadding="0" cellspacing="0" id="text_normal_white" style="text-align:center;">
    ...
    */
    ...
    <tr height="25" bgcolor="#333333" id="text_normal_white">
        ...
        <td width="9%">Paket</td>
        <td width="9%">Pengembangan</td>
        <td width="9%"><span style="color:#FF0000;">Kegiatan</span></td>
        <td width="9%">Peralatan</td>
        <td width="9%"><span style="color:#FF0000;">Seragam</span></td>
        <td width="9%">Paket</td>
        <td width="9%">Pengembangan</td>
        <td width="9%"><span style="color:#FF0000;">Kegiatan</span></td>
        <td width="9%">Peralatan</td>
    ...
    while($row_get_cat_adm_bi_ma	= mysql_fetch_array($query_get_cat_adm_bi_ma)) {
        if($row_get_cat_adm_bi_ma["set_cat_adm"] == "umum") {
            if($row_get_cat_adm_bi_ma["jenjang"] == "tod" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
            ...
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
        ...
        if($row_get_cat_adm_bi_ma["set_cat_adm"] == "umskgrab") {
            if($row_get_cat_adm_bi_ma["jenjang"] == "tod" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
            <tr height="45" bgcolor="#7b8a74" id="text_normal_white">
                <td><input type="text" name="tod_penga_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="pgx_penga_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
                <td><input type="text" name="pgx_kegia_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
                <td><input type="text" name="pgx_peral_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="pgx_serag_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
                <td><input type="text" name="pgx_paket_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }							
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="tka_penga_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
                <td><input type="text" name="tka_kegia_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
                <td><input type="text" name="tka_peral_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="tka_serag_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
                <td><input type="text" name="tka_paket_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }						
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="tkb_penga_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
                <td><input type="text" name="tkb_kegia_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
                <td><input type="text" name="tkb_peral_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="tkb_serag_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
                <td><input type="text" name="tkb_paket_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="sdx_penga_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="sdx_serag_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="smp_penga_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="smp_serag_umskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            </tr>
            <?PHP
            }
        }
		if($row_get_cat_adm_bi_ma["set_cat_adm"] == "ubdskgrab") {
            if($row_get_cat_adm_bi_ma["jenjang"] == "tod" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
            <tr height="45" bgcolor="#7b8a74" id="text_normal_white">
                <td><input type="text" name="tod_penga_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="pgx_penga_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
                <td><input type="text" name="pgx_kegia_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
                <td><input type="text" name="pgx_peral_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="pgx_serag_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
                <td><input type="text" name="pgx_paket_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }							
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="tka_penga_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
                <td><input type="text" name="tka_kegia_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
                <td><input type="text" name="tka_peral_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="tka_serag_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
                <td><input type="text" name="tka_paket_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }						
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="tkb_penga_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>
                <td><input type="text" name="tkb_kegia_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>
                <td><input type="text" name="tkb_peral_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="tkb_serag_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>
                <td><input type="text" name="tkb_paket_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="sdx_penga_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="sdx_serag_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>
                <td><input type="text" name="smp_penga_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>
                <td><input type="text" name="smp_serag_ubdskgrab" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            </tr>
            <?PHP
            }
        }	
        ...
        if($row_get_cat_adm_bi_ma["set_cat_adm"] == "pinpgtksem2") {
			...
			if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="tkb_penga_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="tkb_kegia_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
                <td><input type="text" name="tkb_peral_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="tkb_serag_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>	
                <td><input type="text" name="tkb_paket_pinpgtksem2" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
		...
		if($row_get_cat_adm_bi_ma["set_cat_adm"] == "dafultka") {
            if($row_get_cat_adm_bi_ma["jenjang"] == "tod" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
            <tr height="45" bgcolor="#8a6c66" id="text_normal_white">
                <td><input type="text" name="tod_penga_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="pgx_penga_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="pgx_kegia_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
                <td><input type="text" name="pgx_peral_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="pgx_serag_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>	
                <td><input type="text" name="pgx_paket_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }							
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="tka_penga_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="tka_kegia_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" style="background-color:#FF0000; color:#FFFFFF;"  /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
                <td><input type="text" name="tka_peral_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" readonly="readonly" style="background-color:#999999;" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="tka_serag_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)"  style="background-color:#FF0000; color:#FFFFFF;" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>	
                <td><input type="text" name="tka_paket_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }						
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="tkb_penga_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="tkb_kegia_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
                <td><input type="text" name="tkb_peral_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="tkb_serag_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>	
                <td><input type="text" name="tkb_paket_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="sdx_penga_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="sdx_serag_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="smp_penga_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="smp_serag_dafultka" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            </tr>
            <?PHP
            }
        }
		if($row_get_cat_adm_bi_ma["set_cat_adm"] == "dafultkb") {
            if($row_get_cat_adm_bi_ma["jenjang"] == "tod" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
            <tr height="45" bgcolor="#8a6c66" id="text_normal_white">
                <td><input type="text" name="tod_penga_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="pgx_penga_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="pgx_kegia_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
                <td><input type="text" name="pgx_peral_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="pgx_serag_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "pgx" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>	
                <td><input type="text" name="pgx_paket_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }							
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="tka_penga_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="tka_kegia_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
                <td><input type="text" name="tka_peral_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="tka_serag_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tka" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>	
                <td><input type="text" name="tka_paket_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }						
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="tkb_penga_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "kegia") {
            ?>	
                <td><input type="text" name="tkb_kegia_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" style="background-color:#FF0000; color:#FFFFFF;"  /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "peral") {
            ?>	
                <td><input type="text" name="tkb_peral_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="tkb_serag_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "tkb" && $row_get_cat_adm_bi_ma["cat_adm"] == "paket") {
            ?>	
                <td><input type="text" name="tkb_paket_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="sdx_penga_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "sdx" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="sdx_serag_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "penga") {
            ?>	
                <td><input type="text" name="smp_penga_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            <?PHP
            }
            if($row_get_cat_adm_bi_ma["jenjang"] == "smp" && $row_get_cat_adm_bi_ma["cat_adm"] == "serag") {
            ?>	
                <td><input type="text" name="smp_serag_dafultkb" size="8" value="<?PHP echo $row_get_cat_adm_bi_ma["nominal"]; ?>" onkeypress="return checkIt(event)" /></td>
            </tr>
            <?PHP
            }
        }
