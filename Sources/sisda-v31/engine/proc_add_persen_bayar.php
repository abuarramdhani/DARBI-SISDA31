...
if(isset($_SESSION["id"]) && $_SESSION["privilege"] == "2") {
	...
	$kegiatan_tka 	= mysql_real_escape_string(htmlspecialchars($_POST["kegiatan_tka"]));
	$seragam_tka 	= mysql_real_escape_string(htmlspecialchars($_POST["seragam_tka"]));
	$kegiatan_tkb 	= mysql_real_escape_string(htmlspecialchars($_POST["kegiatan_tkb"]));
	$seragam_tkb	= mysql_real_escape_string(htmlspecialchars($_POST["seragam_tkb"]));
