...
if(isset($_SESSION["id"]) && $_SESSION["privilege"] == "2") {
	...
	if($src_check_data_finance_next_year_eng == $src_en) {
		...
		if($num_check_siswa == 0) {
			...
			$nama_siswa				= $get_tahun_masuk["nama_siswa"];
			
			//Dari tahun ajaran depan, kita ambil 2 angka terakhir buat nauin keterangan discountnya... yoa
			...
			if($status == "anak guru") {
				...
				$prosentase_ks 			= $get_prosentase[$var_elearning] / 100;
