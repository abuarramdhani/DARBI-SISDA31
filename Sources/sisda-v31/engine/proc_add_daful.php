...
if(isset($_SESSION["id"]) && $_SESSION["privilege"] == "2") {
	...
	if($enc == $cek_enc) {
		...
		$nama_siswa			= addslashes($row_cur_status["nama_siswa"]);
		...
		//echo $get_data_daful_spp."<br>";
		//echo mysql_num_rows($query_data_daful_spp)."<br>";
		...
		while($data_daful_spp = mysql_fetch_array($query_data_daful_spp)) {
			...
			//echo $src_nom_daful_spp.'<br>';
			//echo $src_nom_daful_ict.'<br>';
			//echo $src_nom_daful_ler.'<br>';
		...
		//echo "<h1>".$nom_daful_spp."</h1>";
		//echo "<h1>".$nom_daful_spp_prefix."</h1>";
