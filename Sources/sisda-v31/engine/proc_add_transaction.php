...
if(isset($_SESSION["id"]) && $_SESSION["privilege"] == "2") {
	...
	if(!empty($_POST["subtotal_daful"]) && $_POST["subtotal_daful"] != 0) {
		...
		if($tahun_daftar_ulang_enc != "") {
			...
			$exist_db_daful_kegiatan	= $row_get_tunggakan_daful["nom_kegiatan"]; //echo $exist_db_daful_kegiatan."<br>";
			$exist_db_daful_peralatan	= $row_get_tunggakan_daful["nom_peralatan"]; //echo $exist_db_daful_peralatan."<br>";
			$exist_db_daful_seragam		= $row_get_tunggakan_daful["nom_seragam"]; //echo $exist_db_daful_seragam."<br>";
	...
	if(!empty($_POST["subtotal_spp"]) && $_POST["subtotal_spp"] != 0 && !empty($_POST["bulan_spp"])) {
		...
		for($i=0; $i < $count_bulan_spp; $i++) {
			...
			if($get_month_spp == "jul") { $new_update_month_spp = "july"; 		$get_month_spp_full = "Juli"; }
			if($get_month_spp == "aug") { $new_update_month_spp = "august"; 	$get_month_spp_full = "Agustus"; }
			if($get_month_spp == "sep") { $new_update_month_spp = "september"; 	$get_month_spp_full = "September"; }
			if($get_month_spp == "oct") { $new_update_month_spp = "october"; 	$get_month_spp_full = "Oktober"; }
			if($get_month_spp == "nov") { $new_update_month_spp = "november"; 	$get_month_spp_full = "November"; }
			if($get_month_spp == "dec") { $new_update_month_spp = "december"; 	$get_month_spp_full = "Desember"; }
			if($get_month_spp == "jan") { $new_update_month_spp = "january"; 	$get_month_spp_full = "Januari"; }
			if($get_month_spp == "feb") { $new_update_month_spp = "february"; 	$get_month_spp_full = "Februari"; }
			if($get_month_spp == "mar") { $new_update_month_spp = "march"; 		$get_month_spp_full = "Maret"; }
			if($get_month_spp == "apr") { $new_update_month_spp = "april"; 		$get_month_spp_full = "April"; }
			if($get_month_spp == "may") { $new_update_month_spp = "may"; 		$get_month_spp_full = "Mei"; }
			if($get_month_spp == "jun") { $new_update_month_spp = "june"; 		$get_month_spp_full = "Juni"; }
			...
			if($query_update_prefix) {
				...
				$src_total_bulan_spp = $src_total_bulan_spp.$get_month_spp_full.",";
	...
	if(!empty($_POST["subtotal_catering"]) && $_POST["subtotal_catering"] != 0 && !empty($_POST["bulan_catering"])) {
		...
		for($i=0; $i < $count_bulan_catering; $i++) {
			...
			//Juga bulan yang mau di updatenya
			if($get_month_catering == "jul") { $new_update_month_catering = "jul_cataj"; $get_month_catering_full = "Juli"; }
			if($get_month_catering == "aug") { $new_update_month_catering = "aug_cataj"; $get_month_catering_full = "Agustus"; }
			if($get_month_catering == "sep") { $new_update_month_catering = "sep_cataj"; $get_month_catering_full = "September"; }
			if($get_month_catering == "oct") { $new_update_month_catering = "oct_cataj"; $get_month_catering_full = "Oktober"; }
			if($get_month_catering == "nov") { $new_update_month_catering = "nov_cataj"; $get_month_catering_full = "November"; }
			if($get_month_catering == "dec") { $new_update_month_catering = "dec_cataj"; $get_month_catering_full = "Desember"; }
			if($get_month_catering == "jan") { $new_update_month_catering = "jan_cataj"; $get_month_catering_full = "Januari"; }
			if($get_month_catering == "feb") { $new_update_month_catering = "feb_cataj"; $get_month_catering_full = "Februari"; }
			if($get_month_catering == "mar") { $new_update_month_catering = "mar_cataj"; $get_month_catering_full = "Maret"; }
			if($get_month_catering == "apr") { $new_update_month_catering = "apr_cataj"; $get_month_catering_full = "April"; }
			if($get_month_catering == "may") { $new_update_month_catering = "may_cataj"; $get_month_catering_full = "Mei"; }
			if($get_month_catering == "jun") { $new_update_month_catering = "jun_cataj"; $get_month_catering_full = "Juni"; }
			...
			if($query_update_prefix_catering) {
				...
				$bulan_catering_succeed			= $bulan_catering_succeed.$get_month_catering_full.",";
	...
	if(!empty($_POST["subtotal_antar_jemput"]) && $_POST["subtotal_antar_jemput"] != 0 && !empty($_POST["bulan_antar_jemput"])) {
		...
		for($i=0; $i < $count_bulan_antar_jemput; $i++) {
			...
			//Juga bulan yang mau di updatenya
			if($get_month_antar_jemput == "jul") { $new_update_month_antar_jemput = "jul_cataj"; $get_month_antar_jemput_full = "Juli"; }
			if($get_month_antar_jemput == "aug") { $new_update_month_antar_jemput = "aug_cataj"; $get_month_antar_jemput_full = "Agustus"; }
			if($get_month_antar_jemput == "sep") { $new_update_month_antar_jemput = "sep_cataj"; $get_month_antar_jemput_full = "September"; }
			if($get_month_antar_jemput == "oct") { $new_update_month_antar_jemput = "oct_cataj"; $get_month_antar_jemput_full = "Oktober"; }
			if($get_month_antar_jemput == "nov") { $new_update_month_antar_jemput = "nov_cataj"; $get_month_antar_jemput_full = "November"; }
			if($get_month_antar_jemput == "dec") { $new_update_month_antar_jemput = "dec_cataj"; $get_month_antar_jemput_full = "Desember"; }
			if($get_month_antar_jemput == "jan") { $new_update_month_antar_jemput = "jan_cataj"; $get_month_antar_jemput_full = "Januari"; }
			if($get_month_antar_jemput == "feb") { $new_update_month_antar_jemput = "feb_cataj"; $get_month_antar_jemput_full = "Februari"; }
			if($get_month_antar_jemput == "mar") { $new_update_month_antar_jemput = "mar_cataj"; $get_month_antar_jemput_full = "Maret"; }
			if($get_month_antar_jemput == "apr") { $new_update_month_antar_jemput = "apr_cataj"; $get_month_antar_jemput_full = "April"; }
			if($get_month_antar_jemput == "may") { $new_update_month_antar_jemput = "may_cataj"; $get_month_antar_jemput_full = "Maret"; }
			if($get_month_antar_jemput == "jun") { $new_update_month_antar_jemput = "jun_cataj"; $get_month_antar_jemput_full = "Juni"; }
			...
			if($query_update_prefix_antar_jemput) {
				...
				$bulan_antar_jemput_succeed			= $bulan_antar_jemput_succeed.$get_month_antar_jemput_full.",";
