...
$mysql_connect		= mysqli_connect($host,$username,$password);
$mysql_select_db	= mysqli_select_db($mysql_connect, $db);
...
//Set 'true' for run
//Set 'false' for stop
$src_do_update_aktif_siswa_finance = true;
...
$darbi_url = "http://localhost:81/sisda-v31/";
?>
